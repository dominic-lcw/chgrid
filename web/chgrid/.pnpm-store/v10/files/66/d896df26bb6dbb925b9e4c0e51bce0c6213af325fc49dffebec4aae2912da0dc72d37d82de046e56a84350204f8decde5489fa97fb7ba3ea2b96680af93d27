...
export declare class SankeySeries extends FlowProportionSeries<SankeyNodeDatum, SankeyLinkDatum, SankeyNodeLabelDatum, AgSankeySeriesOptions, SankeySeriesProperties, _ModuleSupport.Rect, SankeyLink> {
    ...
    protected getLinkStyle({ datumIndex, datum }: Partial<SankeyLinkDatum>, fromNodeDatumIndex: FlowProportionNodeDatumIndex, isHighlight: boolean): Required<import("ag-charts-community").AgSankeySeriesLinkStyle> & Required<import("ag-charts-community").AgSankeySeriesNodeStyle> & Partial<AgSankeySeriesOptions<any, unknown> & {
        fill: import("ag-charts-community").AgColorType;
        fillOpacity: number;
        stroke: string;
        strokeWidth: number;
