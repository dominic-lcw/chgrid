import type { AgColumn, AgColumnGroup, BeanCollection, CellCtrl, CellPosition, CellRange, CellRangeBoundaryParams, CellRangeParams, ClearCellRangeParams, ICellRangeFeature, IHeaderCellComp, IRangeService, NamedBean, PartialCellRange, RowPinnedType, RowPosition } from 'ag-grid-community';
...
export declare class RangeService extends BeanStub implements NamedBean, IRangeService {
    ...
    getRangeRowCount(cellRange: PartialCellRange): number;
    setRangeToCell(cell: CellPosition, appendRange?: boolean): void;
    private getRangeLastColumn;
    ...
    private focusCellOnNewColumn;
    private focusCellOnNewRow;
