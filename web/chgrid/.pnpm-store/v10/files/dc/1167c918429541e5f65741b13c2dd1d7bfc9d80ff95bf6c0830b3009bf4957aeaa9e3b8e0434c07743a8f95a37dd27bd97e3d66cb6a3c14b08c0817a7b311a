import type { AgHeatmapSeriesOptions, AgHeatmapSeriesStyle, FontStyle, FontWeight, TextAlign, VerticalAlign } from 'ag-charts-community';
...
export declare class HeatmapSeries extends _ModuleSupport.CartesianSeries<_ModuleSupport.Rect, AgHeatmapSeriesOptions, HeatmapSeriesProperties, HeatmapNodeDatum, HeatmapLabelDatum> {
    ...
    protected pickNodesExactShape(point: Point): _ModuleSupport.SeriesNodeDatum<_ModuleSupport.DatumIndexType>[];
