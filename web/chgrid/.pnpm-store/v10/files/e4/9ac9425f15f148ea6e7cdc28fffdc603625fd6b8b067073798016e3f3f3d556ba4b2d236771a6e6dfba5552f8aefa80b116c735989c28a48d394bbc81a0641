...
import type { AgChartLabelFormatterParams, AgGradientColorMode, AgRadialGaugeLabelFormatterParams, AgRadialGaugeMarkerShape, AgRadialGaugeOptions, AgRadialGaugeSeriesStyle, AgRadialGaugeTargetPlacement, AgRadialGaugeTooltipRendererParams, FontStyle, FontWeight, Formatter } from 'ag-charts-types';
...
declare class RadialGaugeBarProperties extends BaseProperties {
    ...
    getStyle(defaultColorRange: string[], scale: _ModuleSupport.LinearScale): RequireOptional<AgRadialGaugeSeriesStyle>;
}
...
declare class RadialGaugeScaleProperties extends BaseProperties {
    ...
    getStyle(barEnabled: boolean, defaultColorRange: string[], scale: _ModuleSupport.LinearScale): RequireOptional<AgRadialGaugeSeriesStyle>;
}
...
export declare function createConicGradient(fills: _ModuleSupport.StopProperties[], fillMode: AgGradientColorMode, defaultColorRange: string[], scale: _ModuleSupport.LinearScale): InternalAgGradientColor;
export {};
