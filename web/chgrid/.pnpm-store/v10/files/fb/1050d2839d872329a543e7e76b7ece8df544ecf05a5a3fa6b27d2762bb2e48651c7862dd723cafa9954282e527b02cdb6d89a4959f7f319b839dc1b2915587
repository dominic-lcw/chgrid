...
var { BaseProperties, ChartAxisDirection, Property: Property2, Group, FONT_SIZE } = import_ag_charts_community2._ModuleSupport;
...
var AngleAxis = class extends import_ag_charts_community4._ModuleSupport.PolarAxis {
  ...
  updateRadiusLine() {
    ...
    points.forEach(({ x, y, moveTo: moveTo2, arc, radius = 0, startAngle = 0, endAngle = 0 }) => {
      if (arc) {
    ...
    const labelData = ticks.map((datum, index) => {
      ...
      if (box && options.hideWhenNecessary && !rotation) {
        ...
        if (overflowLeft > pixelError || overflowRight > pixelError) {
          ...
          text = (0, import_ag_charts_core3.isArray)(text) ? (0, import_ag_charts_core3.wrapTextSegments)(text, wrapOptions) : (0, import_ag_charts_core3.wrapText)(text, wrapOptions);
          tempText.text = text;
...
} = import_ag_charts_community8._ModuleSupport;
var OrdinalTimeAxis = class extends import_ag_charts_community8._ModuleSupport.DiscreteTimeAxis {
  constructor(moduleCtx) {
...
var { Chart } = import_ag_charts_community14._ModuleSupport;
...
// packages/ag-charts-enterprise/src/charts/standaloneChartModule.ts
var { isAgStandaloneChartOptions, standaloneChartOptionsDefs } = import_ag_charts_community15._ModuleSupport;
...
var { Chart: Chart2, MercatorScale, ChartAxisDirection: ChartAxisDirection6, Property: Property11 } = import_ag_charts_community16._ModuleSupport;
...
var TopologyChart = class extends Chart2 {
  constructor(options, resources) {
    ...
    this.ctx.zoomManager.updateAxes([ChartAxisDirection6.X, ChartAxisDirection6.Y]);
  }
  getChartType() {
    return "topology";
  }
  ...
  performLayout(ctx) {
    ...
    if (combinedBbox != null) {
      ...
      const xZoom = this.ctx.zoomManager.getAxisZoom(ChartAxisDirection6.X);
      const yZoom = this.ctx.zoomManager.getAxisZoom(ChartAxisDirection6.Y);
...
// packages/ag-charts-enterprise/src/charts/topologyChartModule.ts
var { isAgTopologyChartOptions, topologyChartOptionsDefs } = import_ag_charts_community17._ModuleSupport;
...
} = import_ag_charts_community18._ModuleSupport;
var serializableDate = (0, import_ag_charts_core9.optionsDefs)(
  {
    __type: (0, import_ag_charts_core9.required)((0, import_ag_charts_core9.constant)("date")),
    value: (0, import_ag_charts_core9.or)(import_ag_charts_core9.string, import_ag_charts_core9.number)
  },
  "a serializable date object"
);
var xValue = (0, import_ag_charts_core9.or)(import_ag_charts_core9.string, import_ag_charts_core9.number, serializableDate);
var annotationValue = (0, import_ag_charts_core9.or)(
  xValue,
  (0, import_ag_charts_core9.optionsDefs)({
    value: xValue,
    groupPercentage: (0, import_ag_charts_core9.numberRange)(-1, 2)
  })
);
var channelAnnotationTextOptionsDef = {
  ...annotationChannelTextDefs,
  label: import_ag_charts_core9.string
};
...
var annotationPointOptionsDef = {
  x: annotationValue,
  y: import_ag_charts_core9.number
};
var annotationInitialStateOptionsDef = (0, import_ag_charts_core9.typeUnion)(
  {
    line: {
      ...annotationLineStyleDefs,
    ...
    "disjoint-channel": {
      ...annotationDisjointChannelStyleDefs,
      startHeight: import_ag_charts_core9.number,
      endHeight: import_ag_charts_core9.number,
      start: annotationPointOptionsDef,
      end: annotationPointOptionsDef,
    ...
    "parallel-channel": {
      ...annotationParallelChannelStyleDefs,
      height: import_ag_charts_core9.number,
      start: annotationPointOptionsDef,
      end: annotationPointOptionsDef,
      text: channelAnnotationTextOptionsDef
    },
    "fibonacci-retracement": {
      ...
      text: lineAnnotationTextOptionsDef,
      reverse: import_ag_charts_core9.boolean
    },
    ...
    callout: {
      ...
      text: import_ag_charts_core9.string
    },
    comment: {
      ...annotationCommentStylesDefs,
    ...
    "date-range": {
      ...annotationMeasurerStylesDefs,
      extendAbove: import_ag_charts_core9.boolean,
      extendBelow: import_ag_charts_core9.boolean,
      text: lineAnnotationTextOptionsDef,
      start: annotationPointOptionsDef,
      end: annotationPointOptionsDef
    },
    "price-range": {
      ...annotationMeasurerStylesDefs,
      extendLeft: import_ag_charts_core9.boolean,
      extendRight: import_ag_charts_core9.boolean,
      text: lineAnnotationTextOptionsDef,
      start: annotationPointOptionsDef,
      end: annotationPointOptionsDef
    },
...
var initialStateOptionsDef = {
  chartType: (0, import_ag_charts_core9.union)("candlestick", "hollow-candlestick", "ohlc", "line", "step-line", "hlc", "high-low"),
  annotations: (0, import_ag_charts_core9.arrayOfDefs)(annotationInitialStateOptionsDef),
  legend: (0, import_ag_charts_core9.arrayOfDefs)(
    {
      visible: import_ag_charts_core9.boolean,
      seriesId: import_ag_charts_core9.string,
      itemId: import_ag_charts_core9.string,
      legendItemName: import_ag_charts_core9.string
    },
    "legend state array"
  ),
  zoom: {
    rangeX: {
      start: (0, import_ag_charts_core9.or)(import_ag_charts_core9.number, serializableDate),
      end: (0, import_ag_charts_core9.or)(import_ag_charts_core9.number, serializableDate)
    },
    rangeY: {
      start: (0, import_ag_charts_core9.or)(import_ag_charts_core9.number, serializableDate),
      end: (0, import_ag_charts_core9.or)(import_ag_charts_core9.number, serializableDate)
    ...
    ratioX: {
      start: (0, import_ag_charts_core9.and)(import_ag_charts_core9.ratio, (0, import_ag_charts_core9.lessThan)("end")),
      end: (0, import_ag_charts_core9.and)(import_ag_charts_core9.ratio, (0, import_ag_charts_core9.greaterThan)("start"))
    },
    ratioY: {
      start: (0, import_ag_charts_core9.and)(import_ag_charts_core9.ratio, (0, import_ag_charts_core9.lessThan)("end")),
      end: (0, import_ag_charts_core9.and)(import_ag_charts_core9.ratio, (0, import_ag_charts_core9.greaterThan)("start"))
    },
    autoScaledAxes: (0, import_ag_charts_core9.arrayOf)((0, import_ag_charts_core9.constant)("y"))
  }
};
...
var BoxPlotNode = class extends Scalable(Path5) {
  constructor() {
    super(...arguments);
  ...
  computeBBox() {
    ...
    return horizontal ? new BBox2(Math.min(min, max), center - thickness / 2, Math.abs(max - min), thickness) : new BBox2(center - thickness / 2, Math.min(min, max), thickness, Math.abs(max - min));
  }
  computeDefaultGradientFillBBox() {
    const { horizontal, center, thickness, q1, q3 } = this;
    return horizontal ? new BBox2(Math.min(q1, q3), center - thickness / 2, Math.abs(q3 - q1), thickness) : new BBox2(center - thickness / 2, Math.min(q1, q3), thickness, Math.abs(q3 - q1));
  }
  isPointInPath(x, y) {
  ...
  updatePath() {
    ...
    if (rectHeight > 0) {
      ...
      clippedRoundRect(
        ...
        rectHeight,
        cornerRadii,
        new BBox2(rectX, rectY, rectWidth, median - rectY)
      );
      clippedRoundRect(
        path,
        horizontal,
        ...
        rectHeight,
        cornerRadii,
        new BBox2(rectX, median, rectWidth, rectY + rectHeight - median)
      );
    } else {
...
function clippedRoundRect(path, horizontal, x, y, width, height, cornerRadii, clipBBox) {
  if (horizontal) {
    baseClippedRoundRect(
      ...
      width,
      cornerRadii,
      clipBBox != null ? new BBox2(clipBBox.y, clipBBox.x, clipBBox.height, clipBBox.width) : void 0
    );
  } else {
...
var { BaseProperties: BaseProperties2, AbstractBarSeriesProperties, makeSeriesTooltip, Property: Property12, mergeDefaults } = import_ag_charts_community20._ModuleSupport;
...
var BoxPlotSeriesNodeEvent = class extends import_ag_charts_community21._ModuleSupport.SeriesNodeEvent {
...
var BoxPlotSeries = class extends import_ag_charts_community21._ModuleSupport.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  getSeriesRange(_direction, visibleRange) {
    return this.domainForVisibleRange(ChartAxisDirection7.Y, ["maxValue", "minValue"], "xValue", visibleRange);
  }
  createNodeData() {
    ...
    rawData.forEach((datum, datumIndex) => {
      ...
      const scaledValues = {
        xValue: xAxis.scale.convert(xValue2),
  ...
  legendItemSymbol() {
    ...
    return {
      marker: {
        fill: import_ag_charts_community21._ModuleSupport.deepClone(fill),
        fillOpacity,
        stroke,
        strokeOpacity,
        strokeWidth,
  ...
  getItemStyle(datumIndex, isHighlight, highlightState) {
    ...
    let style = mergeDefaults2(highlightStyle, properties.getStyle());
    if (itemStyler != null && datumIndex != null) {
      ...
      if (overrides) {
        style = mergeDefaults2(overrides, style);
      }
    }
...
var { boxPlotSeriesThemeableOptionsDef, commonSeriesOptionsDefs } = import_ag_charts_community22._ModuleSupport;
var boxPlotSeriesOptionsDef = {
  ...commonSeriesOptionsDefs,
  ...boxPlotSeriesThemeableOptionsDef,
  type: (0, import_ag_charts_core10.required)((0, import_ag_charts_core10.constant)("box-plot")),
  xKey: (0, import_ag_charts_core10.required)(import_ag_charts_core10.string),
  minKey: (0, import_ag_charts_core10.required)(import_ag_charts_core10.string),
  q1Key: (0, import_ag_charts_core10.required)(import_ag_charts_core10.string),
  medianKey: (0, import_ag_charts_core10.required)(import_ag_charts_core10.string),
  q3Key: (0, import_ag_charts_core10.required)(import_ag_charts_core10.string),
  maxKey: (0, import_ag_charts_core10.required)(import_ag_charts_core10.string),
  xName: import_ag_charts_core10.string,
  yName: import_ag_charts_core10.string,
  minName: import_ag_charts_core10.string,
  q1Name: import_ag_charts_core10.string,
  medianName: import_ag_charts_core10.string,
  q3Name: import_ag_charts_core10.string,
  maxName: import_ag_charts_core10.string,
  grouped: import_ag_charts_core10.boolean,
  legendItemName: import_ag_charts_core10.string,
  segmentation: import_ag_charts_core10.shapeSegmentation
};
...
var BoxPlotModule = {
  ...
  predictAxis: import_ag_charts_community24._ModuleSupport.predictCartesianTimeAxis,
  defaultAxes: import_ag_charts_community24._ModuleSupport.DIRECTION_SWAP_AXES,
...
function aggregateOhlcData(scale, xValues, highValues, lowValues, domain, smallestKeyInterval) {
...
var OhlcSeriesNodeEvent = class extends import_ag_charts_community26._ModuleSupport.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.xKey = series.properties.xKey;
...
var OhlcSeriesBase = class extends import_ag_charts_community26._ModuleSupport.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  getSeriesRange(_direction, visibleRange) {
    return this.domainForVisibleRange(ChartAxisDirection8.Y, ["highValue", "lowValue"], "xValue", visibleRange);
  }
  ...
  createNodeData() {
    ...
    if (dataAggregationFilter == null) {
      ...
      for (let datumIndex = start; datumIndex < end; datumIndex += 1) {
        ...
        if (!validLowValue) {
          import_ag_charts_core11.Logger.warnOnce(
  ...
  getItemStyle(datumIndex, isHighlight, highlightState, itemId = "up") {
    ...
    if (itemStyler && dataModel != null && processedData != null && datumIndex != null) {
      ...
      if (overrides) {
        style = mergeDefaults3(overrides, style);
      }
    }
    return style;
  }
...
var { Path: Path6, SceneChangeDetection: SceneChangeDetection2, BBox: BBox3 } = import_ag_charts_community27._ModuleSupport;
var OhlcBaseNode = class extends Path6 {
  constructor() {
    super(...arguments);
    this.centerX = 0;
    this.y = 0;
...
// packages/ag-charts-enterprise/src/series/candlestick/candlestickNode.ts
var { SceneArrayChangeDetection: SceneArrayChangeDetection2, SceneChangeDetection: SceneChangeDetection3, ExtendedPath2D: ExtendedPath2D2, BBox: BBox4 } = import_ag_charts_community28._ModuleSupport;
var CandlestickNode = class extends OhlcBaseNode {
  constructor() {
    super(...arguments);
    this.wickPath = new ExtendedPath2D2();
    this.wickStroke = void 0;
    this.wickStrokeWidth = void 0;
    this.wickStrokeOpacity = void 0;
  }
...
var { BaseProperties: BaseProperties3, Property: Property13, AbstractBarSeriesProperties: AbstractBarSeriesProperties2, makeSeriesTooltip: makeSeriesTooltip2 } = import_ag_charts_community29._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/candlestick/candlestickSeriesProperties.ts
var { BaseProperties: BaseProperties4, makeSeriesTooltip: makeSeriesTooltip3, Property: Property14 } = import_ag_charts_community30._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/candlestick/candlestickSeries.ts
var { isGradientFill, isPatternFill, isImageFill, applyShapeStyle } = import_ag_charts_community31._ModuleSupport;
var CandlestickSeries = class extends OhlcSeriesBase {
  ...
  updateDatumStyles({
    ...
    datumSelection.each((_, datum) => {
      datum.style = this.getItemStyle(datum.datumIndex, isHighlight, void 0, datum.itemId);
    });
  }
  updateDatumNodes({
    datumSelection,
    ...
    datumSelection.each((node, datum) => {
      ...
      const style = datum.style ?? contextNodeData.styles[datum.itemId][this.getHighlightState(highlightedDatum, isHighlight, datum.datumIndex)];
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs2, candlestickSeriesThemeableOptionsDef } = import_ag_charts_community32._ModuleSupport;
var candlestickSeriesOptionsDef = {
  ...commonSeriesOptionsDefs2,
  ...candlestickSeriesThemeableOptionsDef,
  type: (0, import_ag_charts_core12.required)((0, import_ag_charts_core12.constant)("candlestick")),
  xKey: (0, import_ag_charts_core12.required)(import_ag_charts_core12.string),
  openKey: (0, import_ag_charts_core12.required)(import_ag_charts_core12.string),
  highKey: (0, import_ag_charts_core12.required)(import_ag_charts_core12.string),
  lowKey: (0, import_ag_charts_core12.required)(import_ag_charts_core12.string),
  closeKey: (0, import_ag_charts_core12.required)(import_ag_charts_core12.string),
  xName: import_ag_charts_core12.string,
  yName: import_ag_charts_core12.string,
  openName: import_ag_charts_core12.string,
  highName: import_ag_charts_core12.string,
  lowName: import_ag_charts_core12.string,
  closeName: import_ag_charts_core12.string
};
candlestickSeriesOptionsDef.pickOutsideVisibleMinorAxis = (0, import_ag_charts_core12.undocumented)(import_ag_charts_core12.boolean);
candlestickSeriesOptionsDef.focusPriority = (0, import_ag_charts_core12.undocumented)(import_ag_charts_core12.number);
...
var {
  ...
  FILL_PATTERN_DEFAULTS: FILL_PATTERN_DEFAULTS2
...
// packages/ag-charts-enterprise/src/series/candlestick/candlestickModule.ts
var { CARTESIAN_AXIS_TYPE: CARTESIAN_AXIS_TYPE3, CARTESIAN_POSITION } = import_ag_charts_community34._ModuleSupport.ThemeConstants;
...
function formatStackedLabels(labelValue, labelProps, secondaryLabelValue, secondaryLabelProps, { padding }, sizeFittingHeight) {
  ...
  let label;
  let secondaryLabel;
  return (0, import_ag_charts_core13.findMaxValue)(0, fontSizeCandidates.length - 1, (index) => {
    ...
    const labelLineHeight = (0, import_ag_charts_core13.cachedTextMeasurer)(labelFont).lineHeight();
    const secondaryLabelLineHeight = (0, import_ag_charts_core13.cachedTextMeasurer)(secondaryLabelFont).lineHeight();
...
function formatSingleLabel(value, props, { padding }, sizeFittingHeight) {
  ...
  return (0, import_ag_charts_core13.findMaxValue)(minimumFontSize, props.fontSize, (fontSize) => {
    const currentFont = { ...textSizeProps, fontSize };
    const measurer = (0, import_ag_charts_core13.cachedTextMeasurer)(currentFont);
    ...
    if (lineHeight > availableHeight || availableWidth < 0)
      return;
    const lines = (0, import_ag_charts_core13.wrapLines)(value, {
...
function formatLabels(baseLabelValue, labelProps, baseSecondaryLabelValue, secondaryLabelProps, layoutParams, sizeFittingHeight) {
  ...
  if (hasInvalidFontSize(labelProps) || hasInvalidFontSize(secondaryLabelProps)) {
    import_ag_charts_core13.Logger.warnOnce(`minimumFontSize should be set to a value less than or equal to the font size`);
  }
  let value;
...
function wrapLabel(props, text, maxWidth, maxHeight, font, textWrap, overflow) {
  const lines = (0, import_ag_charts_core13.wrapLines)(text, { maxWidth, maxHeight, font, textWrap, overflow });
  if (!lines.length)
    return;
  const measurer = (0, import_ag_charts_core13.cachedTextMeasurer)(font);
  const lineHeight = props.lineHeight ?? measurer.lineHeight();
...
var { Property: Property15 } = import_ag_charts_community35._ModuleSupport;
var BaseAutoSizedLabel = class extends import_ag_charts_community35._ModuleSupport.Label {
  constructor() {
    super(...arguments);
...
// packages/ag-charts-enterprise/src/series/heatmap/heatmapSeriesProperties.ts
var { CartesianSeriesProperties, makeSeriesTooltip: makeSeriesTooltip4, Property: Property16 } = import_ag_charts_community36._ModuleSupport;
...
var {
  ...
  findQuadtreeMatch,
  updateLabelNode
} = import_ag_charts_community37._ModuleSupport;
var HeatmapSeriesNodeEvent = class extends import_ag_charts_community37._ModuleSupport.CartesianSeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
...
var HeatmapSeries = class extends import_ag_charts_community37._ModuleSupport.CartesianSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      propertyKeys: {
  ...
  async processData(dataController) {
    ...
    if (this.isColorScaleValid()) {
      ...
      const domain = import_ag_charts_community37._ModuleSupport.extent(rawDomain);
  ...
  updateLabelNodes(opts) {
    ...
    opts.labelSelection.each((text, datum) => {
      ...
      updateLabelNode(this, text, this.properties, this.properties.label, datum, false, activeHighlight);
    });
  }
  getTooltipContent(datumIndex) {
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs3, heatmapSeriesThemeableOptionsDef, without } = import_ag_charts_community38._ModuleSupport;
var heatmapSeriesOptionsDef = {
  ...
  type: (0, import_ag_charts_core15.required)((0, import_ag_charts_core15.constant)("heatmap")),
  xKey: (0, import_ag_charts_core15.required)(import_ag_charts_core15.string),
  yKey: (0, import_ag_charts_core15.required)(import_ag_charts_core15.string),
  colorKey: import_ag_charts_core15.string,
  xName: import_ag_charts_core15.string,
  yName: import_ag_charts_core15.string,
  colorName: import_ag_charts_core15.string,
  colorRange: (0, import_ag_charts_core15.arrayOf)(import_ag_charts_core15.color)
};
  ...
  series: {
    ...
    colorRange: {
      $if: [
        ...
        import_ag_charts_community39._ModuleSupport.SAFE_RANGE2_OPERATION
      ]
    },
    label: {
      ...import_ag_charts_community39._ModuleSupport.LABEL_BOXING_DEFAULTS,
      enabled: false,
      color: { $ref: "textColor" },
    ...
    itemPadding: 3,
    highlight: import_ag_charts_community39._ModuleSupport.singleSeriesHighlightStyle()
  },
  gradientLegend: {
    enabled: true,
    ...import_ag_charts_community39._ModuleSupport.LEGEND_CONTAINER_THEME
  }
};
...
var { applyShapeStyle: applyShapeStyle3 } = import_ag_charts_community41._ModuleSupport;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs4, ohlcSeriesThemeableOptionsDef } = import_ag_charts_community42._ModuleSupport;
var ohlcSeriesOptionsDef = {
  ...commonSeriesOptionsDefs4,
  ...ohlcSeriesThemeableOptionsDef,
  type: (0, import_ag_charts_core16.required)((0, import_ag_charts_core16.constant)("ohlc")),
  xKey: (0, import_ag_charts_core16.required)(import_ag_charts_core16.string),
  openKey: (0, import_ag_charts_core16.required)(import_ag_charts_core16.string),
  highKey: (0, import_ag_charts_core16.required)(import_ag_charts_core16.string),
  lowKey: (0, import_ag_charts_core16.required)(import_ag_charts_core16.string),
  closeKey: (0, import_ag_charts_core16.required)(import_ag_charts_core16.string),
  xName: import_ag_charts_core16.string,
  yName: import_ag_charts_core16.string,
  openName: import_ag_charts_core16.string,
  highName: import_ag_charts_core16.string,
  lowName: import_ag_charts_core16.string,
  closeName: import_ag_charts_core16.string
};
ohlcSeriesOptionsDef.pickOutsideVisibleMinorAxis = (0, import_ag_charts_core16.undocumented)(import_ag_charts_core16.boolean);
ohlcSeriesOptionsDef.focusPriority = (0, import_ag_charts_core16.undocumented)(import_ag_charts_core16.number);
...
} = import_ag_charts_community43._ModuleSupport;
var OhlcModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
function aggregateRangeAreaData(scale, xValues, highValues, lowValues, domain) {
  ...
  let maxRange = aggregationRangeFittingPoints2(xValues, d0, d1);
...
var RangeAreaSeriesNodeEvent = class extends import_ag_charts_community47._ModuleSupport.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.xKey = series.properties.xKey;
...
var RangeAreaSeries = class extends import_ag_charts_community47._ModuleSupport.CartesianSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      pathsPerSeries: ["fill", "stroke"],
      pickModes: [import_ag_charts_community47._ModuleSupport.SeriesNodePickMode.AXIS_ALIGNED],
      propertyKeys: {
        [ChartAxisDirection10.X]: ["xKey"],
        [ChartAxisDirection10.Y]: ["yLowKey", "yHighKey"]
      },
      propertyNames: {
        [ChartAxisDirection10.X]: ["xName"],
        [ChartAxisDirection10.Y]: ["yLowName", "yHighName", "yName"]
      },
      categoryKey: "xValue",
      animationResetFns: {
  ...
  xCoordinateRange(xValue2) {
    const x = this.axes[ChartAxisDirection10.X].scale.convert(xValue2);
    return [x, x];
  }
  yCoordinateRange(yValues) {
    const y = this.axes[ChartAxisDirection10.Y].scale.convert(yValues[0]);
    return [y, y];
  }
  getSeriesDomain(direction) {
    const { processedData, dataModel } = this;
    ...
    if (direction === ChartAxisDirection10.X) {
      ...
      const yExtent = this.domainForClippedRange(ChartAxisDirection10.Y, ["yHighValue", "yLowValue"], "xValue");
  ...
  createNodeData() {
    ...
    if (!(data && xAxis && yAxis && dataModel && processedData && this.chart?.seriesRect))
      return;
    const xScale = xAxis.scale;
    const yScale = yAxis.scale;
    const {
  ...
  updateDatumSelection(opts) {
    ...
    const markersEnabled = markerEnabled(processedData.input.count, axes[ChartAxisDirection10.X].scale, marker);
    if (marker.isDirty()) {
  ...
  updateDatumStyles({
    ...
    datumSelection.each((_, datum) => {
      datum.style = this.getMarkerStyle(marker, datum, { xKey, yHighKey, yLowKey }, { isHighlight }, void 0, {
        fill,
        fillOpacity,
        stroke,
        strokeWidth,
  ...
  updateLabelNodes(opts) {
    ...
    opts.labelSelection.each((textNode, datum) => {
      ...
      updateLabelNode2(this, textNode, params, this.properties.label, datum, false, activeHighlight);
    });
  }
  ...
  makeStylerParams(_highlighted, _highlightStateEnum) {
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs5, rangeAreaSeriesThemeableOptionsDef } = import_ag_charts_community48._ModuleSupport;
var rangeAreaSeriesOptionsDef = {
  ...commonSeriesOptionsDefs5,
  ...rangeAreaSeriesThemeableOptionsDef,
  type: (0, import_ag_charts_core17.required)((0, import_ag_charts_core17.constant)("range-area")),
  xKey: (0, import_ag_charts_core17.required)(import_ag_charts_core17.string),
  yLowKey: (0, import_ag_charts_core17.required)(import_ag_charts_core17.string),
  yHighKey: (0, import_ag_charts_core17.required)(import_ag_charts_core17.string),
  xName: import_ag_charts_core17.string,
  yName: import_ag_charts_core17.string,
  yLowName: import_ag_charts_core17.string,
  yHighName: import_ag_charts_core17.string,
  segmentation: import_ag_charts_core17.shapeSegmentation
};
rangeAreaSeriesOptionsDef.pickOutsideVisibleMinorAxis = (0, import_ag_charts_core17.undocumented)(import_ag_charts_core17.boolean);
rangeAreaSeriesOptionsDef.focusPriority = (0, import_ag_charts_core17.undocumented)(import_ag_charts_core17.number);
  ...
  series: {
    fill: {
      $applySwitch: [
        { $path: "type" },
        { $palette: "fill" },
        ["gradient", import_ag_charts_community49._ModuleSupport.FILL_GRADIENT_LINEAR_DEFAULTS],
        ["pattern", import_ag_charts_community49._ModuleSupport.FILL_PATTERN_DEFAULTS]
      ]
    },
    stroke: { $palette: "stroke" },
    fillOpacity: 0.7,
    ...
    marker: {
      ...
      fill: {
        $applySwitch: [
          { $path: "type" },
          { $palette: "fill" },
          ["gradient", import_ag_charts_community49._ModuleSupport.FILL_GRADIENT_RADIAL_REVERSED_DEFAULTS],
          ["image", import_ag_charts_community49._ModuleSupport.FILL_IMAGE_DEFAULTS],
          ["pattern", import_ag_charts_community49._ModuleSupport.FILL_PATTERN_DEFAULTS]
        ]
      },
      stroke: { $palette: "stroke" },
    ...
    label: {
      ...import_ag_charts_community49._ModuleSupport.LABEL_BOXING_DEFAULTS,
      enabled: false,
      placement: "outside",
    ...
    highlight: import_ag_charts_community49._ModuleSupport.multiSeriesHighlightStyle(),
    segmentation: import_ag_charts_community49._ModuleSupport.SEGMENTATION_DEFAULTS
  },
  axes: {
    [import_ag_charts_community49._ModuleSupport.ThemeConstants.CARTESIAN_AXIS_TYPE.NUMBER]: {
...
var RangeAreaModule = {
  ...
  predictAxis: import_ag_charts_community50._ModuleSupport.predictCartesianTimeAxis,
  defaultAxes: [
...
var { aggregationDomain: aggregationDomain3, aggregationRangeFittingPoints: aggregationRangeFittingPoints3, compactAggregationIndices: compactAggregationIndices3, createAggregationIndices: createAggregationIndices3 } = import_ag_charts_community51._ModuleSupport;
var AGGREGATION_THRESHOLD3 = 1e3;
function aggregateRangeBarData(scale, xValues, highValues, lowValues, domain, smallestKeyInterval) {
  if (xValues.length < AGGREGATION_THRESHOLD3)
    return;
  const [d0, d1] = aggregationDomain3(scale, domain);
  let maxRange = aggregationRangeFittingPoints3(xValues, d0, d1, { smallestKeyInterval });
...
var { AbstractBarSeriesProperties: AbstractBarSeriesProperties3, makeSeriesTooltip: makeSeriesTooltip6, Property: Property18, DropShadow: DropShadow2, Label: Label2 } = import_ag_charts_community52._ModuleSupport;
...
var RangeBarSeriesNodeEvent = class extends import_ag_charts_community53._ModuleSupport.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.xKey = series.properties.xKey;
    this.yLowKey = series.properties.yLowKey;
...
var RangeBarSeries = class extends import_ag_charts_community53._ModuleSupport.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  getSeriesRange(_direction, visibleRange) {
    return this.domainForVisibleRange(ChartAxisDirection11.Y, ["yHighValue", "yLowValue"], "xValue", visibleRange);
  }
  createNodeData() {
    const { data, dataModel, groupScale, processedData, visible } = this;
    const xAxis = this.getCategoryAxis();
    const yAxis = this.getValueAxis();
    if (!(data && xAxis && yAxis && dataModel && processedData?.dataSources && this.chart?.seriesRect))
      return;
    const xScale = xAxis.scale;
    const yScale = yAxis.scale;
  ...
  getItemStyle(datumIndex, isHighlight, highlightState) {
    ...
    if (itemStyler && dataModel != null && processedData != null && datumIndex != null) {
      ...
      const xValue2 = dataModel.resolveKeysById(this, `xValue`, processedData)[datumIndex];
      const overrides = this.cachedDatumCallback(
        createDatumId4(this.getDatumId({ xValue: xValue2 }), isHighlight ? "highlight" : "node"),
        () => {
          const activeHighlight = this.ctx.highlightManager?.getActiveHighlight();
          const highlightStateString = this.getHighlightStateString(activeHighlight, isHighlight, datumIndex);
          return this.callWithContext(itemStyler, {
      ...
      if (overrides) {
        style = mergeDefaults6(overrides, style);
      }
    }
    return style;
  }
  ...
  updateLabelNodes(opts) {
    ...
    opts.labelSelection.each((textNode, datum) => {
      textNode.fillOpacity = this.getHighlightStyle(false, datum?.datumIndex).opacity ?? 1;
      updateLabelNode3(this, textNode, params, this.properties.label, datum, false, activeHighlight);
    });
  }
  getTooltipContent(datumIndex) {
    const { id: seriesId, dataModel, processedData, properties } = this;
  ...
  animateWaitingUpdateReady(data) {
    ...
    const dataDiff = import_ag_charts_community53._ModuleSupport.calculateDataDiff(
      this.id,
      datumSelections,
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs6, rangeBarSeriesThemeableOptionsDef } = import_ag_charts_community54._ModuleSupport;
var rangeBarSeriesOptionsDef = {
  ...commonSeriesOptionsDefs6,
  ...rangeBarSeriesThemeableOptionsDef,
  type: (0, import_ag_charts_core18.required)((0, import_ag_charts_core18.constant)("range-bar")),
  xKey: (0, import_ag_charts_core18.required)(import_ag_charts_core18.string),
  yLowKey: (0, import_ag_charts_core18.required)(import_ag_charts_core18.string),
  yHighKey: (0, import_ag_charts_core18.required)(import_ag_charts_core18.string),
  xName: import_ag_charts_core18.string,
  yName: import_ag_charts_core18.string,
  yLowName: import_ag_charts_core18.string,
  yHighName: import_ag_charts_core18.string,
  segmentation: import_ag_charts_core18.shapeSegmentation
};
rangeBarSeriesOptionsDef.pickOutsideVisibleMinorAxis = (0, import_ag_charts_core18.undocumented)(import_ag_charts_core18.boolean);
rangeBarSeriesOptionsDef.focusPriority = (0, import_ag_charts_core18.undocumented)(import_ag_charts_core18.number);
  ...
  series: {
    ...
    fill: {
      $applySwitch: [
        { $path: "type" },
        { $palette: "fill" },
        ["gradient", import_ag_charts_community55._ModuleSupport.FILL_GRADIENT_LINEAR_DEFAULTS],
        ["image", import_ag_charts_community55._ModuleSupport.FILL_IMAGE_DEFAULTS],
        ["pattern", import_ag_charts_community55._ModuleSupport.FILL_PATTERN_DEFAULTS]
      ]
    },
    stroke: { $palette: "stroke" },
    strokeWidth: { $isUserOption: ["./stroke", 2, 0] },
    label: {
      ...import_ag_charts_community55._ModuleSupport.LABEL_BOXING_DEFAULTS,
      enabled: false,
      fontSize: { $ref: "fontSize" },
      fontFamily: { $ref: "fontFamily" },
      fontWeight: { $ref: "fontWeight" },
    ...
    highlight: import_ag_charts_community55._ModuleSupport.multiSeriesHighlightStyle(),
    segmentation: import_ag_charts_community55._ModuleSupport.SEGMENTATION_DEFAULTS
  },
  axes: {
...
var RangeBarModule = {
  ...
  predictAxis: import_ag_charts_community56._ModuleSupport.predictCartesianTimeAxis,
  defaultAxes: import_ag_charts_community56._ModuleSupport.DIRECTION_SWAP_AXES,
...
var { AbstractBarSeriesProperties: AbstractBarSeriesProperties4, BaseProperties: BaseProperties5, PropertiesArray, makeSeriesTooltip: makeSeriesTooltip7, Property: Property19, DropShadow: DropShadow3, Label: Label3 } = import_ag_charts_community57._ModuleSupport;
...
var WaterfallSeries = class extends import_ag_charts_community58._ModuleSupport.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  async processData(dataController) {
    ...
    const { processedData } = await this.requestDataModel(dataController, dataWithTotals, {
      props: [
        ...
        ...isContinuousX ? [import_ag_charts_community58._ModuleSupport.SMALLEST_KEY_INTERVAL, import_ag_charts_community58._ModuleSupport.LARGEST_KEY_INTERVAL] : [],
        ...extraProps
      ]
    });
    this.smallestDataInterval = processedData.reduced?.smallestKeyInterval;
  ...
  getSeriesDomain(direction) {
    ...
    if (direction === this.getCategoryDirection()) {
      ...
      const isDirectionY = direction === ChartAxisDirection12.Y;
  ...
  createNodeData() {
    ...
    const yDomain = this.getSeriesDomain(ChartAxisDirection12.Y);
  ...
  getItemStyle(nodeDatum, isHighlight, highlightState, itemId = "total") {
    const { id: seriesId, properties } = this;
    ...
    if (itemStyler != null && nodeDatum != null) {
      ...
      if (overrides) {
        style = mergeDefaults7(overrides, style);
      }
    }
    return style;
  }
  updateDatumStyles({
    ...
    datumSelection.each((_, datum) => {
      datum.style = this.getItemStyle(datum, isHighlight, void 0, datum.itemId);
    });
  }
  updateDatumNodes({
    datumSelection,
    ...
    const highlightedDatum = this.ctx.highlightManager.getActiveHighlight();
    const categoryAlongX = this.getCategoryDirection() === ChartAxisDirection12.X;
    const fillBBox = this.getShapeFillBBox();
    datumSelection.each((rect, datum) => {
      const style = datum.style ?? contextNodeData.styles[datum.itemId][this.getHighlightState(highlightedDatum, isHighlight, datum.datumIndex)];
  ...
  updateLabelNodes(opts) {
    ...
    opts.labelSelection.each((textNode, datum) => {
      ...
      updateLabelNode4(this, textNode, params, label, datum.label, false, activeHighlight);
    });
  }
  getTooltipContent(datumIndex) {
    const { id: seriesId, dataModel, processedData, properties } = this;
    ...
    const format = this.getItemStyle(nodeDatum, false, void 0, nodeDatum?.itemId);
    return this.formatTooltipWithContext(
      tooltip,
      {
        heading: this.getAxisValueText(xAxis, "tooltip", xValue2, datum, xKey, legendItemName),
  ...
  legendItemSymbol(item) {
    const { fill, stroke, fillOpacity, strokeOpacity, strokeWidth, lineDash, lineDashOffset } = this.getItemConfig(item);
    return {
      marker: {
        fill,
        stroke,
  ...
  animateConnectorLinesHorizontal(opts) {
    ...
    this.ctx.animationManager.animate({
      ...
      from: startX,
      to: endX,
      ease: import_ag_charts_community58._ModuleSupport.Motion.easeOut,
      collapsable: false,
      onUpdate(pointX) {
        linePath.clear(true);
  ...
  updateLineNode(lineNode) {
    ...
    lineNode.setProperties({
      ...
      lineDashOffset,
      lineJoin: "round",
      pointerEvents: import_ag_charts_community58._ModuleSupport.PointerEvents.None
    });
  }
  isLabelEnabled() {
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs7, waterfallSeriesThemeableOptionsDef } = import_ag_charts_community59._ModuleSupport;
var waterfallSeriesOptionsDef = {
  ...waterfallSeriesThemeableOptionsDef,
  ...commonSeriesOptionsDefs7,
  type: (0, import_ag_charts_core19.required)((0, import_ag_charts_core19.constant)("waterfall")),
  xKey: (0, import_ag_charts_core19.required)(import_ag_charts_core19.string),
  yKey: (0, import_ag_charts_core19.required)(import_ag_charts_core19.string),
  xName: import_ag_charts_core19.string,
  yName: import_ag_charts_core19.string,
  totals: (0, import_ag_charts_core19.arrayOfDefs)(
    {
      totalType: (0, import_ag_charts_core19.required)((0, import_ag_charts_core19.union)("total", "subtotal")),
      index: (0, import_ag_charts_core19.required)(import_ag_charts_core19.positiveNumber),
      axisLabel: (0, import_ag_charts_core19.required)(import_ag_charts_core19.string)
    },
...
var { FILL_GRADIENT_LINEAR_SHADED_DEFAULTS: FILL_GRADIENT_LINEAR_SHADED_DEFAULTS2, FILL_IMAGE_DEFAULTS: FILL_IMAGE_DEFAULTS3, FILL_PATTERN_DEFAULTS: FILL_PATTERN_DEFAULTS3 } = import_ag_charts_community60._ModuleSupport;
  ...
  return {
    fill: {
      $applySwitch: [
        ...
        ["gradient", FILL_GRADIENT_LINEAR_SHADED_DEFAULTS2(key)],
    ...
    strokeWidth: { $isUserOption: ["./stroke", 2, 0] },
    label: {
      ...import_ag_charts_community60._ModuleSupport.LABEL_BOXING_DEFAULTS,
      enabled: false,
      fontStyle: void 0,
      fontWeight: { $ref: "fontWeight" },
      fontSize: { $ref: "fontSize" },
...
var WATERFALL_SERIES_THEME = {
  series: {
    ...
    highlight: import_ag_charts_community60._ModuleSupport.singleSeriesHighlightStyle()
  },
  legend: {
    enabled: true,
    toggleSeries: false
...
var navigatorHandleOptionsDef = {
  width: import_ag_charts_core20.positiveNumber,
  height: import_ag_charts_core20.positiveNumber,
  grip: import_ag_charts_core20.boolean,
  fill: import_ag_charts_core20.color,
  stroke: import_ag_charts_core20.color,
  strokeWidth: import_ag_charts_core20.positiveNumber,
  cornerRadius: import_ag_charts_core20.positiveNumber
};
...
var navigatorOptionsDef = {
  enabled: import_ag_charts_core20.boolean,
  height: import_ag_charts_core20.positiveNumber,
  spacing: import_ag_charts_core20.positiveNumber,
  cornerRadius: import_ag_charts_core20.number,
  mask: {
    fill: import_ag_charts_core20.color,
    fillOpacity: import_ag_charts_core20.ratio,
    stroke: import_ag_charts_core20.color,
    strokeWidth: import_ag_charts_core20.positiveNumber
  },
  ...
  miniChart: {
    enabled: import_ag_charts_core20.boolean,
    padding: {
      top: import_ag_charts_core20.positiveNumber,
      bottom: import_ag_charts_core20.positiveNumber
    },
    label: {
      enabled: import_ag_charts_core20.boolean,
      avoidCollisions: import_ag_charts_core20.boolean,
      spacing: import_ag_charts_core20.positiveNumber,
      format: numberFormatValidator,
      formatter: import_ag_charts_core20.callback,
      interval: {
        minSpacing: import_ag_charts_core20.positiveNumber,
        maxSpacing: import_ag_charts_core20.positiveNumber,
        values: import_ag_charts_core20.array,
        step: import_ag_charts_core20.number
      },
      ...import_ag_charts_core20.fontOptionsDef
    },
    series: (0, import_ag_charts_core20.arrayOfDefs)(
      (0, import_ag_charts_core20.typeUnion)(
        {
...
// packages/ag-charts-enterprise/src/features/sync/pluginModules.ts
var { annotationOptionsDef } = import_ag_charts_community63._ModuleSupport;
...
function removeCircularLinks(links) {
  ...
  if (circularLinks.size !== 0) {
    import_ag_charts_core21.Logger.warnOnce("Some links formed circular references. These will be removed from the output.");
  }
...
// packages/ag-charts-enterprise/src/series/flow-proportion/flowProportionSeries.ts
var { Series, DataController, keyProperty: keyProperty6, valueProperty: valueProperty7, Selection: Selection3, Group: Group5, TransformableText } = import_ag_charts_community64._ModuleSupport;
var FlowProportionSeriesNodeEvent = class extends import_ag_charts_community64._ModuleSupport.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
...
var { Path: Path7, SceneChangeDetection: SceneChangeDetection4 } = import_ag_charts_community65._ModuleSupport;
...
var ChordLink = class extends Path7 {
  constructor() {
    super(...arguments);
    this.centerX = 0;
    this.centerY = 0;
...
var {
  ...
  Property: Property20,
  Label: Label4
} = import_ag_charts_community66._ModuleSupport;
...
var ChordSeries = class extends FlowProportionSeries {
  ...
  createNodeData() {
    ...
    nodeGraph.forEach(({ datum: node, linksBefore, linksAfter }, id) => {
      ...
      if (size === 0) {
        ...
        node.size = size;
        totalSize += node.size;
        node.label = label.enabled ? this.getLabelText(
          node.label,
          node.datum,
          labelKey,
          "label",
    ...
    if (this.isLabelEnabled()) {
      const measurer = (0, import_ag_charts_core22.cachedTextMeasurer)(this.properties.label);
      let maxMeasuredLabelWidth = 0;
      nodeGraph.forEach(({ datum: node }) => {
        const { id, label } = node;
        if (label == null)
          return;
        const text = (0, import_ag_charts_core22.wrapText)(label, {
    ...
    if (nodeCount * spacingSweep >= 2 * Math.PI || radius <= 0) {
      import_ag_charts_core22.Logger.warnOnce("There was insufficient space to display the Chord Series.");
      return;
    }
    ...
    labelData = labelData.filter((label) => {
      const labelHeight = (0, import_ag_charts_core22.calcLineHeight)(fontSize);
  ...
  updateLabelNodes(opts) {
    ...
    opts.labelSelection.each((label, { size, text, centerX, centerY, radius, angle }) => {
      params.size = size;
      const style = getLabelStyles(this, void 0, params, this.properties.label, false, activeHighlight);
  ...
  getNodeStyle({ datumIndex, datum, size = 0, label }, fromNodeDatumIndex, isHighlight) {
    ...
    if (itemStyler != null && datumIndex != null) {
      const activeHighlight = this.ctx.highlightManager?.getActiveHighlight();
      const overrides = this.cachedDatumCallback(
        createDatumId6(datumIndex.index, "node", isHighlight ? "highlight" : "node"),
        () => {
          const highlightState = this.getHighlightStateString(activeHighlight, isHighlight, datumIndex);
          return this.callWithContext(itemStyler, {
            seriesId,
  ...
  getLinkStyle({ datumIndex, datum }, fromNodeDatumIndex, isHighlight) {
    ...
    if (itemStyler != null && datumIndex != null) {
      const activeHighlight = this.ctx.highlightManager?.getActiveHighlight();
      const overrides = this.cachedDatumCallback(
        createDatumId6(datumIndex.index, "link", isHighlight ? "highlight" : "node"),
        () => {
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs8, chordSeriesThemeableOptionsDef } = import_ag_charts_community68._ModuleSupport;
var chordSeriesOptionsDef = {
  ...chordSeriesThemeableOptionsDef,
  ...commonSeriesOptionsDefs8,
  type: (0, import_ag_charts_core23.required)((0, import_ag_charts_core23.constant)("chord")),
  fromKey: (0, import_ag_charts_core23.required)(import_ag_charts_core23.string),
  toKey: (0, import_ag_charts_core23.required)(import_ag_charts_core23.string),
  sizeKey: import_ag_charts_core23.string,
  sizeName: import_ag_charts_core23.string
};
chordSeriesOptionsDef.fillGradientDefaults = (0, import_ag_charts_core23.undocumented)(import_ag_charts_core23.fillGradientDefaults);
chordSeriesOptionsDef.fillPatternDefaults = (0, import_ag_charts_core23.undocumented)(import_ag_charts_core23.fillPatternDefaults);
chordSeriesOptionsDef.fillImageDefaults = (0, import_ag_charts_core23.undocumented)(import_ag_charts_core23.fillImageDefaults);
...
var ChordModule = {
  ...
  themeTemplate: {
    series: {
      ...
      // @ts-expect-error undocumented option
      fillGradientDefaults: import_ag_charts_community69._ModuleSupport.FILL_GRADIENT_LINEAR_DEFAULTS,
      fillPatternDefaults: import_ag_charts_community69._ModuleSupport.FILL_PATTERN_DEFAULTS,
      fillImageDefaults: import_ag_charts_community69._ModuleSupport.FILL_IMAGE_DEFAULTS,
      highlightStyle: {
        series: {
          dimOpacity: 0.2
        }
      },
      highlight: import_ag_charts_community69._ModuleSupport.singleSeriesHighlightStyle(),
      label: {
        ...import_ag_charts_community69._ModuleSupport.LABEL_BOXING_DEFAULTS,
        fontFamily: { $ref: "fontFamily" },
        fontSize: { $ref: "fontSize" },
        fontWeight: { $ref: "fontWeight" },
        color: { $ref: "textColor" },
...
var FUNNEL_SERIES_THEME = {
  series: {
      ...
      $applyCycle: [
        ...
        [{ $path: ["/0", void 0, { $palette: "fills" }] }],
        {
          $applySwitch: [
            ...
            { $value: "$1" },
            ["gradient", import_ag_charts_community70._ModuleSupport.FILL_GRADIENT_LINEAR_SINGLE_DEFAULTS],
            ["pattern", import_ag_charts_community70._ModuleSupport.FILL_PATTERN_SINGLE_DEFAULTS],
            ["image", import_ag_charts_community70._ModuleSupport.FILL_IMAGE_DEFAULTS]
          ]
        }
      ]
    },
    ...
    label: {
      ...import_ag_charts_community70._ModuleSupport.LABEL_BOXING_DEFAULTS,
      enabled: true,
      fontSize: { $ref: "fontSize" },
      fontFamily: { $ref: "fontFamily" },
      fontWeight: { $ref: "fontWeight" },
    ...
    highlight: import_ag_charts_community70._ModuleSupport.singleSeriesHighlightStyle()
  },
  axes: {
...
var { lineDistanceSquared, BBox: BBox7, Path: Path8, SceneChangeDetection: SceneChangeDetection5 } = import_ag_charts_community71._ModuleSupport;
var delta = 1e-6;
function pointsEq([ax, ay], [bx, by]) {
  return Math.abs(ax - bx) <= delta && Math.abs(ay - by) <= delta;
}
var FunnelConnector = class extends Path8 {
  constructor() {
    super(...arguments);
    this.x0 = 0;
    this.y0 = 0;
...
var { NODE_UPDATE_STATE_TO_PHASE_MAPPING } = import_ag_charts_community72._ModuleSupport;
...
var FunnelSeriesNodeEvent = class extends import_ag_charts_community73._ModuleSupport.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
...
var BaseFunnelSeries = class extends import_ag_charts_community73._ModuleSupport.AbstractBarSeries {
  constructor({
    moduleCtx,
    animationResetFns
  }) {
    ...
    this.connectorSelection = Selection4.select(
  ...
  createNodeData() {
    ...
    const xScale = xAxis.scale;
    const yScale = yAxis.scale;
    const barAlongX = this.getBarDirection() === ChartAxisDirection13.X;
    const { stageKey, valueKey } = this.properties;
  ...
  updateConnectorNodes(opts) {
    ...
    opts.connectorSelection.each((connector, datum) => {
      const { fill, fillOpacity, stroke, strokeOpacity, strokeWidth, lineDash, lineDashOffset } = this.connectorStyle(datum.datumIndex);
  ...
  updateLabelNodes(opts) {
    ...
    opts.labelSelection.each((textNode, datum) => {
      textNode.fillOpacity = this.getHighlightStyle(false, datum.datumIndex).opacity ?? 1;
      updateLabelNode5(this, textNode, params, this.properties.label, datum, false, activeHighlight);
    });
  }
  getTooltipContent(datumIndex) {
    const { id: seriesId, dataModel, processedData, properties } = this;
  ...
  legendItemSymbol(datumIndex) {
    const { strokeWidth, fillOpacity, strokeOpacity, lineDash, lineDashOffset, fill, stroke } = this.properties.getStyle(datumIndex);
    return {
      marker: {
        fill,
        fillOpacity,
...
var { Label: Label5, AbstractBarSeriesProperties: AbstractBarSeriesProperties5, makeSeriesTooltip: makeSeriesTooltip9, AxisLabel, Property: Property21 } = import_ag_charts_community74._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/cone-funnel/coneFunnelSeries.ts
var { Line: Line3, ChartAxisDirection: ChartAxisDirection14 } = import_ag_charts_community75._ModuleSupport;
var ConeFunnelSeries = class extends BaseFunnelSeries {
  ...
  tooltipStyle(_datum, datumIndex) {
    const { fill, stroke, fillOpacity, strokeOpacity, strokeWidth, lineDash, lineDashOffset } = this.properties.getStyle(datumIndex);
    return {
      fill,
      fillOpacity,
      stroke,
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs9, coneFunnelSeriesThemeableOptionsDef, without: without3 } = import_ag_charts_community76._ModuleSupport;
var coneFunnelSeriesOptionsDef = {
  ...without3(commonSeriesOptionsDefs9, ["showInLegend"]),
  ...coneFunnelSeriesThemeableOptionsDef,
  type: (0, import_ag_charts_core24.required)((0, import_ag_charts_core24.constant)("cone-funnel")),
  stageKey: (0, import_ag_charts_core24.required)(import_ag_charts_core24.string),
  valueKey: (0, import_ag_charts_core24.required)(import_ag_charts_core24.string)
};
...
var CONE_FUNNEL_SERIES_THEME = {
  series: {
      ...
      $applyCycle: [
        { $size: { $path: ["./data", { $path: "/data" }] } },
        {
          $if: [
            ...
            import_ag_charts_community77._ModuleSupport.SAFE_RANGE2_OPERATION
          ]
        },
        {
          $applySwitch: [
            { $path: ["/type", void 0, { $value: "$1" }] },
            { $value: "$1" },
            ["gradient", import_ag_charts_community77._ModuleSupport.FILL_GRADIENT_LINEAR_SINGLE_DEFAULTS],
            ["pattern", import_ag_charts_community77._ModuleSupport.FILL_PATTERN_SINGLE_DEFAULTS],
            ["image", import_ag_charts_community77._ModuleSupport.FILL_IMAGE_DEFAULTS]
          ]
        }
      ]
    },
    ...
    strokeWidth: { $isUserOption: ["./strokes/0", 2, 0] },
    label: {
      ...import_ag_charts_community77._ModuleSupport.LABEL_BOXING_DEFAULTS,
      enabled: true,
      fontSize: { $ref: "fontSize" },
      fontFamily: { $ref: "fontFamily" },
      fontWeight: { $ref: "fontWeight" },
    ...
    highlight: import_ag_charts_community77._ModuleSupport.singleSeriesHighlightStyle(false)
  },
  seriesArea: {
    padding: {
      top: 20,
...
var { Label: Label6, DropShadow: DropShadow4, AbstractBarSeriesProperties: AbstractBarSeriesProperties6, BaseProperties: BaseProperties7, makeSeriesTooltip: makeSeriesTooltip10, AxisLabel: AxisLabel2, Property: Property22 } = import_ag_charts_community78._ModuleSupport;
...
var FunnelSeries = class extends BaseFunnelSeries {
  ...
  connectorStyle(index) {
    return mergeDefaults9(this.properties.dropOff.getStyle(), this.properties.getStyle(index));
  }
  nodeFactory() {
    return new Rect4();
  }
  createLabelData({
    ...
    if (!label.enabled)
      return;
    const yDomain = this.getSeriesDomain(ChartAxisDirection15.Y);
    const text = this.getLabelText(
      yDatum,
      datum,
      valueKey,
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs10, funnelSeriesThemeableOptionsDef, without: without4 } = import_ag_charts_community80._ModuleSupport;
var funnelSeriesOptionsDef = {
  ...funnelSeriesThemeableOptionsDef,
  ...without4(commonSeriesOptionsDefs10, ["showInLegend"]),
  type: (0, import_ag_charts_core25.required)((0, import_ag_charts_core25.constant)("funnel")),
  stageKey: (0, import_ag_charts_core25.required)(import_ag_charts_core25.string),
  valueKey: (0, import_ag_charts_core25.required)(import_ag_charts_core25.string)
};
...
function formatWithContext(ctx, formatter, params) {
  return import_ag_charts_community81._ModuleSupport.callWithContext(ctx.chartService, formatter, params);
}
...
function pickGaugeNearestDatum(self, point) {
  const it = (0, import_ag_charts_core26.iterate)(self.datumUnion.nodes(), self.targetSelection.nodes());
...
function pickGaugeFocus(self, opts) {
  ...
  const otherIndex = (0, import_ag_charts_core26.clamp)(0, opts.otherIndex + opts.otherIndexDelta, others.length - 1);
  if (others.length === 0)
    return;
  const { data, selection } = others[otherIndex];
  if (data == null || data.length === 0)
    return;
  const datumIndex = (0, import_ag_charts_core26.clamp)(0, opts.datumIndex, data.length - 1);
...
var { BaseProperties: BaseProperties8, Property: Property23 } = import_ag_charts_community82._ModuleSupport;
...
var {
  ...
  makeSeriesTooltip: makeSeriesTooltip11,
...
var LinearGaugeBarProperties = class extends BaseProperties9 {
  constructor() {
    ...
    this.fills = new PropertiesArray2(import_ag_charts_community83._ModuleSupport.StopProperties);
  ...
  getStyle(defaultColorRange, horizontal, scale) {
    const { fill, fills, fillMode, fillOpacity, stroke, strokeWidth, strokeOpacity, lineDash, lineDashOffset } = this;
...
var { BBox: BBox8 } = import_ag_charts_community84._ModuleSupport;
...
function formatLinearGaugeLabels(series, ctx, selection, opts, bboxes, datumOverrides) {
  ...
  selection.each((label, labelDatum) => {
    ...
    if (labelText == null) {
      ...
      const measurer = (0, import_ag_charts_core28.cachedTextMeasurer)(labelDatum);
...
var LinearGaugeSeries = class extends import_ag_charts_community85._ModuleSupport.Series {
  constructor(moduleCtx) {
    super({
      moduleCtx,
    ...
    this.scaleSelection = Selection5.select(
      this.scaleGroup,
      () => this.nodeFactory()
    );
    ...
    this.targetSelection = Selection5.select(
      this.itemTargetGroup,
      () => this.markerFactory()
    );
    this.targetLabelSelection = Selection5.select(this.itemTargetLabelGroup, Text);
    this.labelSelection = Selection5.select(
      this.itemLabelGroup,
      Text
    );
    this.highlightTargetSelection = Selection5.select(this.highlightTargetGroup, () => this.markerFactory());
    this.tickSelection = Selection5.select(this.tickGroup, TransformableText2);
  ...
  getShapeFillBBox() {
    ...
    const bbox = new BBox9(originX, originY, horizontal ? length : thickness, horizontal ? thickness : length);
    return {
      axis: bbox,
      series: bbox
    };
  ...
  verticalLabelInset() {
    ...
    const measurer = (0, import_ag_charts_core29.cachedTextMeasurer)(label);
  ...
  updateDatumNodes(opts) {
    ...
    datumSelection.each((rect, datum) => {
      ...
      applyShapeStyle10(rect, datum.style, fillBBox);
      ...
      rect.pointerEvents = this.properties.bar.enabled ? import_ag_charts_community85._ModuleSupport.PointerEvents.All : import_ag_charts_community85._ModuleSupport.PointerEvents.None;
    ...
    this.datumUnion.update(datumSelection, this.itemGroup, import_ag_charts_community85._ModuleSupport.Rect, (node, first, last) => {
      ...
      node.pointerEvents = import_ag_charts_community85._ModuleSupport.PointerEvents.None;
      node.x = left;
      node.y = top;
      node.width = width;
      node.height = height;
      ...
      if (firstClipBBox && lastClipBBox) {
        node.clipBBox = BBox9.merge([firstClipBBox, lastClipBBox]).intersection(
          horizontal ? new BBox9(left, -Infinity, width, Infinity) : new BBox9(-Infinity, top, Infinity, height)
        );
      } else {
  ...
  getTargetStyle(isHighlight, { datumIndex, style }) {
    const highlightStyle = this.getHighlightStyle(isHighlight, datumIndex);
    return mergeDefaults10(highlightStyle, {
      ...style,
      opacity: 1
    });
  }
    ...
    series: {
      ...
      defaultColorRange: {
        $if: [
          ...
          import_ag_charts_community86._ModuleSupport.SAFE_RANGE2_OPERATION
        ]
      },
      scale: {
        // @ts-expect-error undocumented option
        ...
        stroke: { $path: ["/2", import_ag_charts_community86._ModuleSupport.SAFE_STROKE_FILL_OPERATION, { $palette: "hierarchyColors" }] },
        // TODO: mix backgroundColor and foregroundColor?
        strokeWidth: { $isUserOption: ["./stroke", 2, 0] },
        label: {
          spacing: 11
      ...
      label: {
        ...import_ag_charts_community86._ModuleSupport.LABEL_BOXING_DEFAULTS,
        enabled: false,
        placement: "inside-start",
        fontFamily: { $ref: "fontFamily" },
        fontWeight: { $ref: "fontWeight" },
        fontSize: { $rem: 2 },
        minimumFontSize: import_ag_charts_community86._ModuleSupport.FONT_SIZE.SMALL,
        spacing: 18,
        color: { $ref: "chartBackgroundColor" }
      },
      margin: 4,
...
var LinearGaugeSeriesModule = {
  ...
  chartType: "standalone",
  enterprise: true,
  options: import_ag_charts_community86._ModuleSupport.linearGaugeSeriesOptionsDef,
...
var MAP_THEME_DEFAULTS = {
  ...
  gradientLegend: {
    enabled: false,
    ...import_ag_charts_community87._ModuleSupport.LEGEND_CONTAINER_THEME
  }
};
function applyMapPalette(object) {
  const clone = import_ag_charts_community87._ModuleSupport.deepClone(object);
  import_ag_charts_community87._ModuleSupport.jsonWalk(clone, (value) => {
...
var { LonLatBBox } = import_ag_charts_community88._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/map-util/geoGeometry.ts
var { Path: Path9, ExtendedPath2D: ExtendedPath2D3, BBox: BBox10, SceneChangeDetection: SceneChangeDetection6, SceneObjectChangeDetection, objectsEqual } = import_ag_charts_community89._ModuleSupport;
var GeoGeometry = class extends Path9 {
  constructor() {
    super(...arguments);
    this.projectedGeometry = void 0;
    this.renderMode = 3 /* All */;
    // Keep non-filled shapes separate so we don't fill them
    this.strokePath = new ExtendedPath2D3();
  }
  computeBBox() {
...
var { LonLatBBox: LonLatBBox2 } = import_ag_charts_community90._ModuleSupport;
...
var TopologySeriesProperties = class extends import_ag_charts_community91._ModuleSupport.SeriesProperties {
};
var TopologySeries = class extends import_ag_charts_community91._ModuleSupport.DataModelSeries {
...
var { Property: Property25, SeriesProperties: SeriesProperties3, makeSeriesTooltip: makeSeriesTooltip12, Label: Label8 } = import_ag_charts_community92._ModuleSupport;
...
var MapLineSeries = class extends TopologySeries {
  constructor(moduleCtx) {
    ...
    this.labelSelection = Selection6.select(this.labelGroup, Text2);
  ...
  async processData(dataController) {
    ...
    if (topology == null) {
      import_ag_charts_core30.Logger.warnOnce(`no topology was provided for [MapLineSeries]; nothing will be rendered.`);
    }
  }
  isColorScaleValid() {
    const { colorKey } = this.properties;
  ...
  createNodeData() {
    ...
    const measurer = (0, import_ag_charts_core30.cachedTextMeasurer)(label);
    ...
    if (missingGeometries.length > 0) {
      import_ag_charts_core30.Logger.warnOnce(`some data items do not have matches in the provided topology`, missingGeometries);
    }
    return {
      itemId: seriesId,
      nodeData,
  ...
  getItemStyle({ datumIndex = 0, datum, colorValue, sizeValue }, isHighlight) {
    ...
    let overrides;
    if (itemStyler != null) {
      overrides = this.cachedDatumCallback(createDatumId10(datumIndex, isHighlight ? "highlight" : "node"), () => {
        const activeHighlight = this.ctx.highlightManager?.getActiveHighlight();
        const highlightState = this.getHighlightStateString(activeHighlight, isHighlight, datumIndex);
        return this.callWithContext(itemStyler, {
          seriesId,
    ...
    return overrides ? mergeDefaults11(baseStyle, overrides) : baseStyle;
  }
  updateDatumStyles({
    datumSelection,
    isHighlight
  ...
  updatePlacedLabelData(labelData) {
    this.labelSelection = this.labelSelection.update(labelData, (text) => {
      text.pointerEvents = import_ag_charts_community93._ModuleSupport.PointerEvents.None;
    });
    this.updateLabelNodes({ labelSelection: this.labelSelection });
  }
  updateLabelNodes(opts) {
    ...
    opts.labelSelection.each((label, { x, y, width, height, text }, datumIndex) => {
      const style = getLabelStyles2(this, void 0, properties, properties.label, false, activeHighlight);
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs11, mapLineSeriesThemeableOptionsDef, without: without5 } = import_ag_charts_community94._ModuleSupport;
var mapLineSeriesOptionsDef = {
  ...without5(commonSeriesOptionsDefs11, ["highlightStyle", "highlight"]),
  ...mapLineSeriesThemeableOptionsDef,
  type: (0, import_ag_charts_core31.required)((0, import_ag_charts_core31.constant)("map-line")),
  idKey: (0, import_ag_charts_core31.required)(import_ag_charts_core31.string),
  sizeKey: import_ag_charts_core31.string,
  colorKey: import_ag_charts_core31.string,
  labelKey: import_ag_charts_core31.string,
  idName: import_ag_charts_core31.string,
  sizeName: import_ag_charts_core31.string,
  colorName: import_ag_charts_core31.string,
  labelName: import_ag_charts_core31.string,
  topology: import_ag_charts_core31.geoJson,
  topologyIdKey: import_ag_charts_core31.string,
  legendItemName: import_ag_charts_core31.string,
  title: import_ag_charts_core31.string
};
mapLineSeriesOptionsDef.colorRange = (0, import_ag_charts_core31.undocumented)((0, import_ag_charts_core31.and)((0, import_ag_charts_core31.arrayOf)(import_ag_charts_core31.color), (0, import_ag_charts_core31.arrayLength)(1)));
...
var MapLineModule = {
  ...
  themeTemplate: {
    ...MAP_THEME_DEFAULTS,
    series: {
      stroke: applyMapPalette(import_ag_charts_community95._ModuleSupport.SAFE_STROKE_FILL_OPERATION),
      // @ts-expect-error undocumented option
      colorRange: {
        $if: [
          { $eq: [{ $mapPalette: "type" }, "inbuilt"] },
          { $mapPalette: "divergingColors" },
          applyMapPalette(import_ag_charts_community95._ModuleSupport.SAFE_RANGE2_OPERATION)
        ]
      },
      strokeWidth: 1,
      maxStrokeWidth: 3,
      ...
      lineDashOffset: 0,
      label: {
        ...import_ag_charts_community95._ModuleSupport.LABEL_BOXING_DEFAULTS,
        enabled: true,
        fontSize: { $ref: "fontSize" },
        fontFamily: { $ref: "fontFamily" },
        fontWeight: { $ref: "fontWeight" },
      ...
      highlight: applyMapPalette(import_ag_charts_community95._ModuleSupport.multiSeriesHighlightStyle(false))
    },
    tooltip: {
      range: "exact"
    }
...
var { Property: Property26, SeriesProperties: SeriesProperties4, makeSeriesTooltip: makeSeriesTooltip13 } = import_ag_charts_community96._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/map-line-background/mapLineBackgroundSeries.ts
var { createDatumId: createDatumId11, Group: Group8, Selection: Selection7, PointerEvents: PointerEvents6 } = import_ag_charts_community97._ModuleSupport;
var MapLineBackgroundSeries = class extends TopologySeries {
  ...
  processData() {
    ...
    if (topology == null) {
      import_ag_charts_core32.Logger.warnOnce(`no topology was provided for [MapShapeBackgroundSeries]; nothing will be rendered.`);
    }
  }
  createNodeData() {
...
var { mapLineBackgroundSeriesThemeableOptionsDef } = import_ag_charts_community98._ModuleSupport;
var mapLineBackgroundSeriesOptionsDef = {
  ...mapLineBackgroundSeriesThemeableOptionsDef,
  type: (0, import_ag_charts_core33.required)((0, import_ag_charts_core33.constant)("map-line-background")),
  topology: import_ag_charts_core33.geoJson
};
...
function polygonPointSearch(polygons, precision, valueFn) {
  ...
  while (queue != null) {
    ...
    queue = (0, import_ag_charts_core34.insertListItemsSorted)(queue, newLabelPlacements, labelPlacementCmp);
  }
  if (bestResult == null)
    return;
...
var { BBox: BBox11 } = import_ag_charts_community99._ModuleSupport;
...
var { Property: Property27, SeriesProperties: SeriesProperties5, makeSeriesTooltip: makeSeriesTooltip14, Label: Label9 } = import_ag_charts_community100._ModuleSupport;
...
var MapMarkerSeries = class extends TopologySeries {
  constructor(moduleCtx) {
    ...
    this.labelSelection = Selection8.select(this.labelGroup, Text3, false);
    this.markerSelection = Selection8.select(
      this.markerGroup,
      Marker3,
      false
    );
    this.highlightMarkerSelection = Selection8.select(this.highlightGroup, Marker3);
  ...
  createNodeData() {
    ...
    const measurer = (0, import_ag_charts_core35.cachedTextMeasurer)(label);
  ...
  updatePlacedLabelData(labelData) {
    this.labelSelection = this.labelSelection.update(labelData, (text) => {
      text.pointerEvents = import_ag_charts_community101._ModuleSupport.PointerEvents.None;
    });
    this.updateLabelNodes({ labelSelection: this.labelSelection });
  }
  updateLabelNodes(opts) {
    ...
    const activeHighlight = this.ctx.highlightManager?.getActiveHighlight();
    opts.labelSelection.each((label, { x, y, width, height, text }, datumIndex) => {
      const style = getLabelStyles3(this, void 0, properties, properties.label, false, activeHighlight);
      const { color: fill, fontStyle, fontWeight, fontSize, fontFamily } = style;
      label.visible = true;
      label.x = x + width / 2;
      label.y = y + height / 2;
  ...
  getMarkerItemStyle({ datumIndex, datum, colorValue, sizeValue }, isHighlight) {
    ...
    if (itemStyler != null && datumIndex != null) {
      ...
      if (overrides) {
        style = mergeDefaults12(overrides, baseStyle);
      }
    }
    return style;
  }
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs12, mapMarkerSeriesThemeableOptionsDef, without: without6 } = import_ag_charts_community102._ModuleSupport;
    ...
    series: {
      ...
      fill: applyMapPalette({
        $applySwitch: [
          { $path: "type" },
          { $mapPalette: "fill" },
          ["gradient", import_ag_charts_community103._ModuleSupport.FILL_GRADIENT_RADIAL_REVERSED_DEFAULTS],
          ["image", import_ag_charts_community103._ModuleSupport.FILL_IMAGE_DEFAULTS],
          ["pattern", import_ag_charts_community103._ModuleSupport.FILL_PATTERN_DEFAULTS]
        ]
      }),
      ...
      colorRange: {
        $if: [
          { $eq: [{ $mapPalette: "type" }, "inbuilt"] },
          { $mapPalette: "divergingColors" },
          applyMapPalette(import_ag_charts_community103._ModuleSupport.SAFE_RANGE2_OPERATION)
        ]
      },
      fillOpacity: 0.5,
      label: {
        ...import_ag_charts_community103._ModuleSupport.LABEL_BOXING_DEFAULTS,
        enabled: false,
        fontSize: { $ref: "fontSize" },
        fontFamily: { $ref: "fontFamily" },
        fontWeight: { $ref: "fontWeight" },
      ...
      highlight: applyMapPalette(import_ag_charts_community103._ModuleSupport.multiSeriesHighlightStyle())
    },
    tooltip: {
      range: "exact"
    }
...
var { Property: Property28, SeriesProperties: SeriesProperties6, makeSeriesTooltip: makeSeriesTooltip15 } = import_ag_charts_community104._ModuleSupport;
...
var fixedScale = import_ag_charts_community105._ModuleSupport.MercatorScale.fixedScale();
var MapShapeSeries = class extends TopologySeries {
  ...
  getLabelLayout(datum, labelValue, measurer, geometry, previousLabelLayout) {
    ...
    const aspectRatio = (baseSize.width + 2 * padding) / (numLines * (0, import_ag_charts_core38.calcLineHeight)(label.fontSize) + 2 * padding);
  ...
  createNodeData() {
    ...
    const labelValues = labelKey != null ? dataModel.resolveColumnById(this, `labelValue`, processedData) : void 0;
    const colorValues = colorKey != null ? dataModel.resolveColumnById(this, `colorValue`, processedData) : void 0;
    const measurer = (0, import_ag_charts_core38.cachedTextMeasurer)(label);
  ...
  updateDatumNodes({
    ...
    datumSelection.each((geoGeometry, nodeDatum) => {
      ...
      geoGeometry.visible = true;
      geoGeometry.projectedGeometry = projectedGeometry;
      applyShapeStyle12(geoGeometry, nodeDatum.style, fillBBox);
    });
  }
  updateLabelSelection(opts) {
    const labels = this.isLabelEnabled() ? opts.labelData : [];
  ...
  updateLabelNodes(opts) {
    ...
    opts.labelSelection.each((label, { x, y, text, fontSize, lineHeight }, datumIndex) => {
      const style = getLabelStyles4(this, void 0, properties, properties.label, false, activeHighlight);
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs13, mapShapeSeriesThemeableOptionsDef, without: without7 } = import_ag_charts_community106._ModuleSupport;
    ...
    series: {
      fill: applyMapPalette({
        $applySwitch: [
          { $path: "type" },
          { $mapPalette: "fill" },
          ["gradient", import_ag_charts_community107._ModuleSupport.FILL_GRADIENT_LINEAR_DEFAULTS],
          ["image", import_ag_charts_community107._ModuleSupport.FILL_IMAGE_DEFAULTS],
          ["pattern", import_ag_charts_community107._ModuleSupport.FILL_PATTERN_DEFAULTS]
        ]
      }),
      ...
      colorRange: {
        $if: [
          { $eq: [{ $mapPalette: "type" }, "inbuilt"] },
          { $mapPalette: "divergingColors" },
          applyMapPalette(import_ag_charts_community107._ModuleSupport.SAFE_RANGE2_OPERATION)
        ]
      },
      fillOpacity: 1,
      strokeWidth: 1,
      ...
      padding: 2,
      label: {
        ...import_ag_charts_community107._ModuleSupport.LABEL_BOXING_DEFAULTS,
        color: { $ref: "chartBackgroundColor" },
        fontFamily: { $ref: "fontFamily" },
        fontSize: { $ref: "fontSize" },
        fontWeight: "bold",
      ...
      highlight: applyMapPalette(import_ag_charts_community107._ModuleSupport.multiSeriesHighlightStyle(true))
    },
    tooltip: {
      range: "exact"
    }
...
var { Property: Property29, SeriesProperties: SeriesProperties7, makeSeriesTooltip: makeSeriesTooltip16 } = import_ag_charts_community108._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/map-shape-background/mapShapeBackgroundSeries.ts
var { createDatumId: createDatumId14, Selection: Selection10, Group: Group11, PointerEvents: PointerEvents8 } = import_ag_charts_community109._ModuleSupport;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs14, mapShapeBackgroundSeriesThemeableOptionsDef } = import_ag_charts_community110._ModuleSupport;
    ...
    series: {
      fill: applyMapPalette({
        $applySwitch: [
          ...
          ["gradient", import_ag_charts_community111._ModuleSupport.FILL_GRADIENT_LINEAR_HIERARCHY_DEFAULTS],
          ["image", import_ag_charts_community111._ModuleSupport.FILL_IMAGE_DEFAULTS],
          ["pattern", import_ag_charts_community111._ModuleSupport.FILL_PATTERN_HIERARCHY_DEFAULTS]
        ]
      }),
      stroke: { $ref: "chartBackgroundColor" },
      strokeWidth: 1
...
var RadialColumnSeriesNodeEvent = class extends import_ag_charts_community112._ModuleSupport.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
...
var RadialColumnSeriesBase = class extends import_ag_charts_community112._ModuleSupport.PolarSeries {
  constructor(moduleCtx, {
    animationResetFns
  }) {
    super({
  ...
  isRadiusAxisReversed() {
    return this.axes[ChartAxisDirection16.Radius]?.isReversed();
  }
  ...
  getItemStyle(nodeDatum, isHighlight, highlightState) {
    const { id: seriesId, properties } = this;
    ...
    if (itemStyler != null && nodeDatum != null) {
      ...
      if (overrides) {
        style = mergeDefaults14(overrides, style);
      }
    }
    return style;
  }
  ...
  legendItemSymbol() {
    ...
    if (import_ag_charts_community112._ModuleSupport.isGradientFill(markerStyle.fill)) {
...
var { SeriesProperties: SeriesProperties8, makeSeriesTooltip: makeSeriesTooltip17, Property: Property30, Label: Label10 } = import_ag_charts_community113._ModuleSupport;
...
var { motion: motion7 } = import_ag_charts_community114._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/nightingale/nightingaleUtil.ts
var { SectorBox, motion: motion8 } = import_ag_charts_community115._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/nightingale/nightingaleSeries.ts
var { Sector: Sector4, SectorBox: SectorBox2, PolarZIndexMap } = import_ag_charts_community116._ModuleSupport;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs15, nightingaleSeriesThemeableOptionsDef } = import_ag_charts_community117._ModuleSupport;
...
var {
  ...
  FILL_IMAGE_DEFAULTS: FILL_IMAGE_DEFAULTS4,
  FILL_PATTERN_DEFAULTS: FILL_PATTERN_DEFAULTS4
...
var NIGHTINGALE_SERIES_THEME = {
  series: {
    ...
    strokeWidth: 1,
    label: {
      ...import_ag_charts_community118._ModuleSupport.LABEL_BOXING_DEFAULTS,
      enabled: false,
      fontSize: { $ref: "fontSize" },
      fontFamily: { $ref: "fontFamily" },
      fontWeight: { $ref: "fontWeight" },
...
var { SeriesProperties: SeriesProperties9, makeSeriesTooltip: makeSeriesTooltip18, Property: Property31, Label: Label11, DropShadow: DropShadow5 } = import_ag_charts_community120._ModuleSupport;
...
var PyramidSeries = class extends import_ag_charts_community121._ModuleSupport.DataModelSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      categoryKey: void 0,
    ...
    this.stageLabelSelection = Selection11.select(this.stageLabelGroup, Text5);
  ...
  createNodeData() {
    ...
    const textMeasurer = (0, import_ag_charts_core44.cachedTextMeasurer)(stageLabel);
    let textAlign;
    let textBaseline;
    if (horizontal) {
      textAlign = "center";
    ...
    rawData.forEach((datum, datumIndex) => {
      ...
      const height = text.split("\n").length * (0, import_ag_charts_core44.calcLineHeight)(label.fontSize);
  ...
  getItemStyle({ datumIndex, datum }, isHighlight) {
    ...
    const { stageKey, valueKey, itemStyler } = properties;
    const highlightStyle = this.getHighlightStyle(isHighlight, datumIndex);
    const baseStyle = mergeDefaults15(highlightStyle, properties.getStyle(datumIndex));
    let style = baseStyle;
    if (itemStyler != null && datumIndex != null) {
      const activeHighlight = this.ctx.highlightManager?.getActiveHighlight();
      const overrides = this.cachedDatumCallback(
      ...
      if (overrides) {
        style = mergeDefaults15(overrides, style);
      }
    }
    return style;
  }
  ...
  updateDatumNodes({
    ...
    datumSelection.each((connector, nodeDatum) => {
      applyShapeStyle14(connector, nodeDatum.style, fillBBox);
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs16, pyramidSeriesThemeableOptionsDef } = import_ag_charts_community122._ModuleSupport;
var pyramidSeriesOptionsDef = {
  ...pyramidSeriesThemeableOptionsDef,
  ...commonSeriesOptionsDefs16,
  type: (0, import_ag_charts_core45.required)((0, import_ag_charts_core45.constant)("pyramid")),
  stageKey: (0, import_ag_charts_core45.required)(import_ag_charts_core45.string),
  valueKey: (0, import_ag_charts_core45.required)(import_ag_charts_core45.string)
};
...
var PYRAMID_SERIES_THEME = {
  series: {
      ...
      $applyCycle: [
        ...
        { $palette: "fills" },
        {
          $applySwitch: [
            { $path: ["/type", void 0, { $value: "$1" }] },
            { $value: "$1" },
            ["gradient", import_ag_charts_community123._ModuleSupport.FILL_GRADIENT_LINEAR_DEFAULTS],
            ["pattern", import_ag_charts_community123._ModuleSupport.FILL_PATTERN_DEFAULTS],
            ["image", import_ag_charts_community123._ModuleSupport.FILL_IMAGE_DEFAULTS]
          ]
        }
      ]
    },
    ...
    label: {
      ...import_ag_charts_community123._ModuleSupport.LABEL_BOXING_DEFAULTS,
      enabled: true,
      fontSize: { $ref: "fontSize" },
      fontFamily: { $ref: "fontFamily" },
      fontWeight: { $ref: "fontWeight" },
    ...
    // @ts-expect-error undocumented option
    highlight: import_ag_charts_community123._ModuleSupport.singleSeriesHighlightStyle()
  }
};
...
var BASE_RADAR_SERIES_THEME = {
  series: {
    stroke: { $palette: "stroke" },
    label: {
      ...import_ag_charts_community124._ModuleSupport.LABEL_BOXING_DEFAULTS,
      enabled: false,
      fontSize: { $ref: "fontSize" },
      fontFamily: { $ref: "fontFamily" },
      fontWeight: { $ref: "fontWeight" },
    ...
    marker: {
      ...
      fill: {
        $applySwitch: [
          { $path: "type" },
          { $palette: "fill" },
          ["gradient", import_ag_charts_community124._ModuleSupport.FILL_GRADIENT_RADIAL_REVERSED_DEFAULTS],
          ["image", import_ag_charts_community124._ModuleSupport.FILL_IMAGE_DEFAULTS],
          ["pattern", import_ag_charts_community124._ModuleSupport.FILL_PATTERN_DEFAULTS]
        ]
      },
      stroke: { $palette: "stroke" },
      fillOpacity: 1,
    ...
    highlight: import_ag_charts_community124._ModuleSupport.multiSeriesHighlightStyle(),
    tooltip: {
      range: { $path: ["/tooltip/range", "nearest"] }
    }
  },
...
var RADAR_LINE_SERIES_THEME = import_ag_charts_community124._ModuleSupport.mergeDefaults(
  {
    series: {
      stroke: import_ag_charts_community124._ModuleSupport.SAFE_STROKE_FILL_OPERATION,
      strokeWidth: 2
    }
  },
  BASE_RADAR_SERIES_THEME
);
var RADAR_AREA_SERIES_THEME = import_ag_charts_community124._ModuleSupport.mergeDefaults(
  {
    series: {
      fill: {
        $applySwitch: [
          { $path: "type" },
          { $palette: "fill" },
          ["gradient", import_ag_charts_community124._ModuleSupport.FILL_GRADIENT_LINEAR_DEFAULTS],
          ["image", import_ag_charts_community124._ModuleSupport.FILL_IMAGE_DEFAULTS],
          ["pattern", import_ag_charts_community124._ModuleSupport.FILL_PATTERN_DEFAULTS]
        ]
      },
...
var { Label: Label12, SeriesMarker: SeriesMarker2, SeriesProperties: SeriesProperties10, makeSeriesTooltip: makeSeriesTooltip19, Property: Property32 } = import_ag_charts_community125._ModuleSupport;
...
var RadarSeriesNodeEvent = class extends import_ag_charts_community126._ModuleSupport.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.angleKey = series.properties.angleKey;
    this.radiusKey = series.properties.radiusKey;
...
var RadarSeries = class extends import_ag_charts_community126._ModuleSupport.PolarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      categoryKey: "angleValue",
    ...
    this.lineSelection = Selection12.select(
      this.lineGroup,
      Path10
    );
  ...
  createNodeData() {
    ...
    if (!processedData || !dataModel)
      return;
    const { angleKey, radiusKey, angleName, radiusName, marker, label, stroke, strokeWidth, strokeOpacity } = this.properties;
    const angleScale = this.axes[ChartAxisDirection17.Angle]?.scale;
    const radiusScale = this.axes[ChartAxisDirection17.Radius]?.scale;
    if (!angleScale || !radiusScale) {
      return;
    }
    ...
    const radiusDomain = this.getSeriesDomain(ChartAxisDirection17.Radius);
    const rawData = processedData.dataSources.get(this.id) ?? [];
    const nodeData = rawData.map((datum, datumIndex) => {
      ...
      if (label.enabled) {
        ...
        if (labelText) {
          let textAlign = "right";
          if ((0, import_ag_charts_core46.isNumberEqual)(cos, 0)) {
            textAlign = "center";
          } else if (cos > 0) {
            textAlign = "left";
          }
          let textBaseline = "bottom";
          if ((0, import_ag_charts_core46.isNumberEqual)(sin, 0)) {
            textBaseline = "middle";
          } else if (sin > 0) {
            textBaseline = "top";
          }
      ...
      return {
        ...
        angleValue: angleDatum,
        radiusValue: radiusDatum,
        missing: !(0, import_ag_charts_core46.isFiniteNumber)(angle) || !(0, import_ag_charts_core46.isFiniteNumber)(radius)
      };
    });
    return {
      itemId: radiusKey,
      nodeData,
      labelData: nodeData,
      styles: getMarkerStyles2(this, marker, { stroke, strokeWidth, strokeOpacity })
    };
  }
  update({ seriesRect }) {
    const resize = this.checkResize(seriesRect);
  ...
  updateMarkerSelection() {
    ...
    if (marker.isDirty()) {
      ...
      this.itemSelection = Selection12.select(this.itemGroup, () => this.nodeFactory(), false);
    }
  ...
  updateHighlightSelection() {
    ...
    if (marker.isDirty()) {
      ...
      this.highlightSelection = Selection12.select(this.highlightGroup, () => this.nodeFactory(), false);
    }
    const highlighted = this.ctx.highlightManager?.getActiveHighlight();
    const data = this.visible && marker.shape && marker.enabled && highlighted?.datum ? [{ ...highlighted }] : [];
  ...
  updatePathNodes() {
    ...
    if (!lineNode)
      return;
    const { strokeWidth, stroke, strokeOpacity, lineDash, lineDashOffset, opacity } = mergeDefaults16(
...
var { Property: Property33 } = import_ag_charts_community127._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/radar-area/radarAreaSeries.ts
var { Group: Group14, Path: Path11, PointerEvents: PointerEvents11, Selection: Selection13, ChartAxisDirection: ChartAxisDirection18, applyShapeStyle: applyShapeStyle15, mergeDefaults: mergeDefaults17 } = import_ag_charts_community128._ModuleSupport;
var RadarAreaSeries = class extends RadarSeries {
  constructor(moduleCtx) {
    ...
    this.areaSelection = Selection13.select(
      this.areaGroup,
      Path11
    );
  ...
  updatePathNodes() {
    ...
    const { fill, fillOpacity, opacity } = mergeDefaults17(this.getHighlightStyle(), this.properties);
    const areaNode = this.getAreaNode();
    if (areaNode) {
      applyShapeStyle15(areaNode, { fill, fillOpacity, stroke: void 0 }, this.getShapeFillBBox());
  ...
  getAreaPoints() {
    ...
    const getPolarAxis = (direction) => {
      ...
      return axis instanceof import_ag_charts_community128._ModuleSupport.PolarAxis ? axis : void 0;
    };
    const radiusAxis = getPolarAxis(ChartAxisDirection18.Radius);
    const angleAxis = getPolarAxis(ChartAxisDirection18.Angle);
    const reversedRadiusAxis = radiusAxis?.isReversed();
  ...
  resetPaths() {
    ...
    if (areaNode) {
      ...
      areaPath.clear(true);
      areaPoints.forEach(({ x, y, moveTo: moveTo2, arc, radius = 0, startAngle = 0, endAngle = 0 }) => {
        if (arc) {
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs17, radarAreaSeriesThemeableOptionsDef } = import_ag_charts_community129._ModuleSupport;
var radarAreaSeriesOptionsDef = {
  ...commonSeriesOptionsDefs17,
  ...radarAreaSeriesThemeableOptionsDef,
  type: (0, import_ag_charts_core47.required)((0, import_ag_charts_core47.constant)("radar-area")),
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs18, radarLineSeriesThemeableOptionsDef } = import_ag_charts_community131._ModuleSupport;
var radarLineSeriesOptionsDef = {
  ...commonSeriesOptionsDefs18,
  ...radarLineSeriesThemeableOptionsDef,
  type: (0, import_ag_charts_core48.required)((0, import_ag_charts_core48.constant)("radar-line")),
  angleKey: (0, import_ag_charts_core48.required)(import_ag_charts_core48.string),
  radiusKey: (0, import_ag_charts_core48.required)(import_ag_charts_core48.string),
  angleName: import_ag_charts_core48.string,
  radiusName: import_ag_charts_core48.string
};

// packages/ag-charts-enterprise/src/series/radar-line/radarLineModule.ts
var { POLAR_AXIS_TYPE: POLAR_AXIS_TYPE5 } = import_ag_charts_community132._ModuleSupport.ThemeConstants;
var RadarLineModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
var { SeriesProperties: SeriesProperties11, makeSeriesTooltip: makeSeriesTooltip20, Property: Property34, Label: Label13 } = import_ag_charts_community133._ModuleSupport;
...
var { SectorBox: SectorBox3, motion: motion9 } = import_ag_charts_community134._ModuleSupport;
...
var RadialBarSeriesNodeEvent = class extends import_ag_charts_community135._ModuleSupport.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.angleKey = series.properties.angleKey;
    this.radiusKey = series.properties.radiusKey;
...
var RadialBarSeries = class extends import_ag_charts_community135._ModuleSupport.PolarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  getSeriesDomain(direction) {
    ...
    if (!processedData || !dataModel)
      return [];
    if (direction === ChartAxisDirection19.Angle) {
  ...
  async processData(dataController) {
    ...
    const stackGroupTrailingId = `${stackGroupId}-trailing`;
    const extraProps = [];
    if ((0, import_ag_charts_core49.isDefined)(normalizedTo)) {
    ...
    const visibleProps = this.visible ? {} : { forceValue: 0 };
    const radiusScaleType = this.axes[ChartAxisDirection19.Radius]?.scale.type;
    const angleScaleType = this.axes[ChartAxisDirection19.Angle]?.scale.type;
    await this.requestDataModel(dataController, this.data, {
      props: [
  ...
  createNodeData() {
    ...
    if (!dataModel || !processedData || processedData.type !== "grouped")
      return;
    const angleAxis = this.axes[ChartAxisDirection19.Angle];
    const radiusAxis = this.axes[ChartAxisDirection19.Radius];
    const angleScale = angleAxis?.scale;
    const radiusScale = radiusAxis?.scale;
    if (!angleScale || !radiusScale) {
    ...
    const axisOuterRadius = radiusAxisReversed ? this.getAxisInnerRadius() : this.radius;
    const axisTotalRadius = axisOuterRadius + axisInnerRadius;
    const angleDomain = this.getSeriesDomain(ChartAxisDirection19.Angle);
    const { angleKey, radiusKey, angleName, radiusName, label } = this.properties;
    ...
    const context = {
      ...
      nodeData,
      labelData: nodeData,
      styles: getItemStyles4(this.getItemStyle.bind(this))
    };
    if (!this.visible)
      return context;
    const { dataSources } = processedData;
  ...
  getItemStyle(nodeDatum, isHighlight, highlightState) {
    ...
    const { angleKey, radiusKey, itemStyler } = properties;
    const highlightStyle = this.getHighlightStyle(isHighlight, nodeDatum?.datumIndex, highlightState);
    const baseStyle = mergeDefaults18(highlightStyle, properties.getStyle());
    let style = baseStyle;
    if (itemStyler != null && nodeDatum != null) {
      const overrides = this.cachedDatumCallback(
  ...
  updateSectorSelection(selection, isHighlight) {
    ...
    selection.update(selectionData, void 0, (datum) => this.getDatumId(datum)).each((node, nodeDatum) => {
      ...
      const fill = style.fill;
      const fillParams = import_ag_charts_community135._ModuleSupport.isGradientFill(fill) && fill.bounds !== "item" ? { centerX: 0, centerY: 0 } : void 0;
  ...
  getBarTransitionFunctions() {
    const angleScale = this.axes[ChartAxisDirection19.Angle]?.scale;
    let axisZeroAngle = 0;
    if (!angleScale) {
  ...
  getTooltipContent(datumIndex) {
    const { id: seriesId, dataModel, processedData, axes, properties } = this;
    const { angleKey, angleName, radiusKey, radiusName, tooltip } = properties;
    const angleAxis = axes[ChartAxisDirection19.Angle];
    const radiusAxis = axes[ChartAxisDirection19.Radius];
    const nodeDatum = this.nodeData?.[datumIndex];
    if (!dataModel || !processedData || !angleAxis || !radiusAxis || !nodeDatum)
      return;
    const datum = processedData.dataSources.get(this.id)?.[datumIndex];
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs19, radialBarSeriesThemeableOptionsDef } = import_ag_charts_community136._ModuleSupport;
var radialBarSeriesOptionsDef = {
  ...commonSeriesOptionsDefs19,
  ...radialBarSeriesThemeableOptionsDef,
  type: (0, import_ag_charts_core50.required)((0, import_ag_charts_core50.constant)("radial-bar")),
...
var {
  ...
  FILL_IMAGE_DEFAULTS: FILL_IMAGE_DEFAULTS5,
  FILL_PATTERN_DEFAULTS: FILL_PATTERN_DEFAULTS5
...
var RADIAL_BAR_SERIES_THEME = {
  series: {
    ...
    strokeWidth: { $isUserOption: ["./stroke", 1, 0] },
    label: {
      ...import_ag_charts_community137._ModuleSupport.LABEL_BOXING_DEFAULTS,
      enabled: false,
      fontSize: { $ref: "fontSize" },
      fontFamily: { $ref: "fontFamily" },
      fontWeight: { $ref: "fontWeight" },
...
// packages/ag-charts-enterprise/src/series/radial-bar/radialBarModule.ts
var { POLAR_AXIS_TYPE: POLAR_AXIS_TYPE7 } = import_ag_charts_community138._ModuleSupport.ThemeConstants;
var RadialBarModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
var { Property: Property35 } = import_ag_charts_community139._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/radial-column/radialColumnSeries.ts
var { ChartAxisDirection: ChartAxisDirection20, PolarAxis: PolarAxis4, RadialColumnShape, getRadialColumnWidth } = import_ag_charts_community140._ModuleSupport;
var RadialColumnSeries = class extends RadialColumnSeriesBase {
  ...
  isRadiusAxisCircle() {
    const radiusAxis = this.axes[ChartAxisDirection20.Radius];
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs20, radialColumnSeriesThemeableOptionsDef } = import_ag_charts_community141._ModuleSupport;
var radialColumnSeriesOptionsDef = {
  ...commonSeriesOptionsDefs20,
  ...radialColumnSeriesThemeableOptionsDef,
  type: (0, import_ag_charts_core51.required)((0, import_ag_charts_core51.constant)("radial-column")),
  angleKey: (0, import_ag_charts_core51.required)(import_ag_charts_core51.string),
  radiusKey: (0, import_ag_charts_core51.required)(import_ag_charts_core51.string),
  angleName: import_ag_charts_core51.string,
  radiusName: import_ag_charts_core51.string,
  grouped: import_ag_charts_core51.boolean,
  stacked: import_ag_charts_core51.boolean,
  stackGroup: import_ag_charts_core51.string,
  normalizedTo: import_ag_charts_core51.number
};
...
var {
  ...
  FILL_GRADIENT_RADIAL_SERIES_DEFAULTS: FILL_GRADIENT_RADIAL_SERIES_DEFAULTS2,
  FILL_IMAGE_DEFAULTS: FILL_IMAGE_DEFAULTS6,
  FILL_PATTERN_DEFAULTS: FILL_PATTERN_DEFAULTS6
...
var RADIAL_COLUMN_SERIES_THEME = {
  series: {
    ...
    strokeWidth: { $isUserOption: ["./stroke", 1, 0] },
    label: {
      ...import_ag_charts_community142._ModuleSupport.LABEL_BOXING_DEFAULTS,
      enabled: false,
      fontSize: { $ref: "fontSize" },
      fontFamily: { $ref: "fontFamily" },
      fontWeight: { $ref: "fontWeight" },
...
// packages/ag-charts-enterprise/src/series/radial-column/radialColumnModule.ts
var { POLAR_AXIS_TYPE: POLAR_AXIS_TYPE9 } = import_ag_charts_community143._ModuleSupport.ThemeConstants;
...
var { SvgPath, Rotatable, Translatable, Scalable: Scalable2 } = import_ag_charts_community144._ModuleSupport;
...
var { getColorStops: getColorStops2, normalizeAngle360: normalizeAngle3606, normalizeAngle360Inclusive: normalizeAngle360Inclusive2, toDegrees } = import_ag_charts_community145._ModuleSupport;
var { BaseProperties: BaseProperties10, makeSeriesTooltip: makeSeriesTooltip21, SeriesProperties: SeriesProperties12, PropertiesArray: PropertiesArray3, AxisLabel: AxisLabel4, Property: Property36, Label: Label14 } = import_ag_charts_community145._ModuleSupport;
...
var RadialGaugeBarProperties = class extends BaseProperties10 {
  constructor() {
    super(...arguments);
    this.enabled = true;
    this.fills = new PropertiesArray3(import_ag_charts_community145._ModuleSupport.StopProperties);
    this.fillMode = "continuous";
    this.fillOpacity = 1;
    this.stroke = "black";
    this.strokeWidth = 0;
...
var { SectorBox: SectorBox5 } = import_ag_charts_community146._ModuleSupport;
...
var RadialGaugeSeries = class extends import_ag_charts_community147._ModuleSupport.Series {
  constructor(moduleCtx) {
    super({
      moduleCtx,
    ...
    this.scaleSelection = Selection14.select(
      this.scaleGroup,
      () => this.nodeFactory()
    );
    ...
    this.needleSelection = Selection14.select(
      this.itemNeedleGroup,
      RadialGaugeNeedle
    );
    this.targetSelection = Selection14.select(
      this.itemTargetGroup,
      () => this.markerFactory()
    );
    this.targetLabelSelection = Selection14.select(this.itemTargetLabelGroup, Text7);
    this.labelSelection = Selection14.select(
      this.itemLabelGroup,
      Text7
    );
    this.highlightTargetSelection = Selection14.select(this.highlightTargetGroup, () => this.markerFactory());
    this.tickSelection = Selection14.select(this.tickGroup, import_ag_charts_community147._ModuleSupport.TransformableText);
    this.datumUnion = new DatumUnion();
  ...
  layoutScale() {
    ...
    const measurer = (0, import_ag_charts_core52.cachedTextMeasurer)(label);
  ...
  getShapeFillBBox() {
    ...
    const bbox = new BBox14(centerX - radius, centerY - radius, 2 * radius, 2 * radius);
    return {
      series: bbox,
      axis: bbox
    };
  ...
  updateDatumNodes(opts) {
    ...
    datumSelection.each((sector, datum) => {
      ...
      sector.pointerEvents = this.properties.bar.enabled ? import_ag_charts_community147._ModuleSupport.PointerEvents.All : import_ag_charts_community147._ModuleSupport.PointerEvents.None;
      applyShapeStyle17(sector, datum.style, fillBBox);
    ...
    this.datumUnion.update(datumSelection, this.itemGroup, import_ag_charts_community147._ModuleSupport.Sector, (node, first, last) => {
      ...
      node.pointerEvents = import_ag_charts_community147._ModuleSupport.PointerEvents.None;
    });
  }
  updateScaleSelection(opts) {
    return opts.scaleSelection.update(opts.scaleData, void 0, (datum) => {
  ...
  updateNeedleSelection(opts) {
    return opts.needleSelection.update(opts.needleData, void 0, () => createDatumId18(0));
  }
  ...
  updateTargetNodes({
    ...
    targetSelection.each((target, datum) => {
      ...
      applyShapeStyle17(target, datum.style);
      target.size = size;
      target.shape = shape === "line" ? lineMarker : shape;
  ...
  getTargetStyle(isHighlight, { datumIndex, style }) {
    const highlightStyle = this.getHighlightStyle(isHighlight, datumIndex);
    return mergeDefaults19(highlightStyle, {
      ...style,
      opacity: 1
    });
  }
...
// packages/ag-charts-enterprise/src/series/radial-gauge/radialGaugeModule.ts
var { FONT_SIZE_RATIO } = import_ag_charts_community148._ModuleSupport;
    ...
    series: {
      ...
      defaultColorRange: {
        $if: [
          { $eq: [{ $palette: "type" }, "inbuilt"] },
          { $interpolate: [{ $palette: "secondDivergingColors" }, 5] },
          import_ag_charts_community148._ModuleSupport.SAFE_RANGE2_OPERATION
        ]
      },
      scale: {
        // @ts-expect-error undocumented option
        defaultFill: { $path: ["/1", { $palette: "fill" }, { $palette: "hierarchyColors" }] },
        // TODO: mix backgroundColor and foregroundColor?
        stroke: { $path: ["/2", import_ag_charts_community148._ModuleSupport.SAFE_STROKE_FILL_OPERATION, { $palette: "hierarchyColors" }] },
        // TODO: mix backgroundColor and foregroundColor?
        strokeWidth: { $isUserOption: ["./stroke", 2, 0] },
        label: {
          fontWeight: { $ref: "fontWeight" },
      ...
      label: {
        ...import_ag_charts_community148._ModuleSupport.LABEL_BOXING_DEFAULTS,
        enabled: true,
        fontWeight: { $ref: "fontWeight" },
        fontSize: 56,
...
var RadialGaugeSeriesModule = {
  ...
  chartType: "standalone",
  enterprise: true,
  options: import_ag_charts_community148._ModuleSupport.radialGaugeSeriesOptionsDef,
...
var { BBox: BBox15, Path: Path12, SceneChangeDetection: SceneChangeDetection7, splitBezier2D } = import_ag_charts_community149._ModuleSupport;
...
var SankeyLink = class extends Path12 {
  constructor() {
    super(...arguments);
    this.x1 = 0;
    this.x2 = 0;
...
var SankeySeries = class extends FlowProportionSeries {
  ...
  createNodeData() {
    ...
    const measurer = (0, import_ag_charts_core53.cachedTextMeasurer)(this.properties.label);
    columns.forEach((column, index) => {
      ...
      column.nodes.forEach(({ datum: node }) => {
        ...
        let text;
        if (!leading && !trailing) {
          const lineHeight = (0, import_ag_charts_core53.calcLineHeight)(fontSize);
          ...
          text = (0, import_ag_charts_core53.wrapText)(node.label, {
            maxWidth,
  ...
  updateLabelNodes(opts) {
    ...
    opts.labelSelection.each((label, datum) => {
      ...
      const params = datum;
      const style = getLabelStyles6(this, void 0, params, this.properties.label, false, activeHighlight);
      const { color: fill, fontStyle, fontWeight, fontSize, fontFamily } = style;
      label.visible = true;
      label.x = x;
      label.y = y;
  ...
  getNodeStyle({ datumIndex, datum, size = 0, label }, fromNodeDatumIndex, isHighlight) {
    ...
    const highlightStyle = this.getHighlightStyle(isHighlight, datumIndex);
    const baseStyle = mergeDefaults20(highlightStyle, properties.getStyle(false, fills, strokes, fromNodeDatumIndex));
  ...
  getLinkStyle({ datumIndex, datum }, fromNodeDatumIndex, isHighlight) {
    ...
    const highlightStyle = this.getHighlightStyle(isHighlight, datumIndex);
    const baseStyle = mergeDefaults20(
      highlightStyle,
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs21, sankeySeriesThemeableOptionsDef } = import_ag_charts_community152._ModuleSupport;
...
var SankeyModule = {
  ...
  themeTemplate: {
    ...
    series: {
      ...
      strokes: { $palette: "strokes" },
      // @ts-expect-error undocumented option
      fillGradientDefaults: import_ag_charts_community153._ModuleSupport.FILL_GRADIENT_LINEAR_DEFAULTS,
      fillPatternDefaults: import_ag_charts_community153._ModuleSupport.FILL_PATTERN_DEFAULTS,
      fillImageDefaults: import_ag_charts_community153._ModuleSupport.FILL_IMAGE_DEFAULTS,
      defaultColorRange: { $palette: "gradients" },
      defaultPatternFills: import_ag_charts_community153._ModuleSupport.SAFE_FILLS_OPERATION,
      highlightStyle: {
        series: {
          dimOpacity: 0.2
        }
      ...
      highlight: {
        ...import_ag_charts_community153._ModuleSupport.singleSeriesHighlightStyle()
      },
      label: {
        ...import_ag_charts_community153._ModuleSupport.LABEL_BOXING_DEFAULTS,
        fontFamily: { $ref: "fontFamily" },
        fontSize: { $ref: "fontSize" },
        fontWeight: { $ref: "fontWeight" },
        color: { $ref: "textColor" },
...
var { HierarchySeriesProperties, HighlightStyle, makeSeriesTooltip: makeSeriesTooltip23, Property: Property38 } = import_ag_charts_community154._ModuleSupport;
...
var SunburstNode = class extends import_ag_charts_community155._ModuleSupport.HierarchyNode {
  constructor() {
    super(...arguments);
    this.label = void 0;
...
var SunburstSeries = class extends import_ag_charts_community155._ModuleSupport.HierarchySeries {
  constructor(moduleCtx) {
    super(moduleCtx);
    ...
    this.datumSelection = Selection15.select(this.sectorGroup, Sector7);
    this.labelSelection = Selection15.select(
      this.sectorLabelGroup,
      Group16
    );
    this.highlightSelection = Selection15.select(
  ...
  getItemStyle(nodeDatum, isHighlight) {
    ...
    const baseStyle = mergeDefaults21(highlightStyle, properties.getStyle(rootIndex));
    ...
    if (itemStyler != null && nodeDatum != null) {
      ...
      if (overrides) {
        style = mergeDefaults21(overrides, style);
      }
    }
    return style;
  }
  updateNodes() {
    ...
    const updateSector = (nodeDatum, sector, highlighted) => {
      ...
      const fillBBox = import_ag_charts_community155._ModuleSupport.isGradientFill(fill) && fill.bounds !== "item" ? seriesFillBBox : void 0;
  ...
  getTooltipContent(datumIndex) {
    ...
    if (import_ag_charts_community155._ModuleSupport.isGradientFill(markerStyle.fill)) {
      markerStyle.fill = { ...markerStyle.fill, gradient: "linear", rotation: 0, reverse: false };
    }
    return this.formatTooltipWithContext(
      tooltip,
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs22, sunburstSeriesThemeableOptionsDef, without: without8 } = import_ag_charts_community156._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/sunburst/sunburstModule.ts
var { BASE_FONT_SIZE, FONT_SIZE_RATIO: FONT_SIZE_RATIO2 } = import_ag_charts_community157._ModuleSupport;
var SunburstModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
  ...
  themeTemplate: {
    series: {
        ...
        $applyCycle: [
          ...
          { $palette: "fills" },
          {
            $applySwitch: [
              { $path: ["/type", void 0, { $value: "$1" }] },
              { $value: "$1" },
              ["gradient", import_ag_charts_community157._ModuleSupport.FILL_GRADIENT_RADIAL_REVERSED_SERIES_DEFAULTS],
              ["pattern", import_ag_charts_community157._ModuleSupport.FILL_PATTERN_DEFAULTS],
              ["image", import_ag_charts_community157._ModuleSupport.FILL_IMAGE_DEFAULTS]
            ]
          }
        ]
      },
      ...
      strokeWidth: { $isUserOption: ["./strokes/0", 2, 0] },
      label: {
        ...import_ag_charts_community157._ModuleSupport.LABEL_BOXING_DEFAULTS,
        fontFamily: { $ref: "fontFamily" },
    ...
    gradientLegend: {
      enabled: true,
      ...import_ag_charts_community157._ModuleSupport.LEGEND_CONTAINER_THEME
    }
  }
};
...
var { BaseProperties: BaseProperties12, HierarchySeriesProperties: HierarchySeriesProperties2, HighlightStyle: HighlightStyle2, makeSeriesTooltip: makeSeriesTooltip24, Property: Property39, Label: Label16 } = import_ag_charts_community158._ModuleSupport;
...
var TreemapNode = class extends import_ag_charts_community159._ModuleSupport.HierarchyNode {
  constructor() {
    super(...arguments);
...
var DistantGroup = class extends import_ag_charts_community159._ModuleSupport.Group {
  distanceSquared(x, y) {
    return this.getBBox().distanceSquared(x, y);
  }
};
var TreemapSeries = class extends import_ag_charts_community159._ModuleSupport.HierarchySeries {
  constructor() {
    super(...arguments);
    ...
    this.datumSelection = Selection16.select(this.rectGroup, Rect7);
    this.labelSelection = Selection16.select(this.labelGroup, Group17);
  ...
  groupTitleHeight(node, bbox) {
    ...
    if (labelValue == null) {
      ...
      const { height: fontHeight } = (0, import_ag_charts_core56.cachedTextMeasurer)(font).measureLines(labelValue);
  ...
  getItemStyle(nodeDatum, isLeaf, isHighlight) {
    ...
    const baseStyle = mergeDefaults22(highlightStyle, properties.getStyle(isLeaf, fills, strokes, index));
    ...
    if (itemStyler != null && nodeDatum != null) {
      ...
      if (overrides) {
        style = mergeDefaults22(overrides, style);
      }
    }
    return style;
  }
  ...
  updateNodes() {
    ...
    this.rootNode?.walk((node) => {
      ...
      if (children.length === 0) {
        ...
        const text = (0, import_ag_charts_core56.wrapText)(labelValue, {
        ...
        node.label = {
          ...
          lineHeight: (0, import_ag_charts_core56.calcLineHeight)(group.label.fontSize),
          fontStyle,
          fontFamily,
          fontWeight,
          color: color6,
    ...
    const updateLabelFn = (node, text, tag, highlighted) => {
      ...
      const activeHighlight = this.ctx.highlightManager?.getActiveHighlight();
      const style = getLabelStyles8(this, node, params, labelProps, highlighted, activeHighlight);
      text.text = label.text;
      text.fontSize = label.fontSize;
      text.lineHeight = label.lineHeight;
      text.fontStyle = label.fontStyle;
  ...
  getTooltipContent(datumIndex) {
    ...
    if (import_ag_charts_community159._ModuleSupport.isGradientFill(markerStyle.fill)) {
      markerStyle.fill = { ...markerStyle.fill, gradient: "linear", rotation: 0, reverse: false };
    }
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs23, treemapSeriesThemeableOptionsDef, without: without9 } = import_ag_charts_community160._ModuleSupport;
...
// packages/ag-charts-enterprise/src/series/treemap/treemapModule.ts
var { FONT_SIZE_RATIO: FONT_SIZE_RATIO3 } = import_ag_charts_community161._ModuleSupport;
var TreemapModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
  ...
  themeTemplate: {
    series: {
        ...
        $applyCycle: [
          ...
          { $palette: "fills" },
          {
            $applySwitch: [
              { $path: ["/type", void 0, { $value: "$1" }] },
              { $value: "$1" },
              ["gradient", import_ag_charts_community161._ModuleSupport.FILL_GRADIENT_LINEAR_DEFAULTS],
              ["pattern", import_ag_charts_community161._ModuleSupport.FILL_PATTERN_DEFAULTS],
              ["image", import_ag_charts_community161._ModuleSupport.FILL_IMAGE_DEFAULTS]
            ]
          }
        ]
      },
      ...
      group: {
        label: {
          ...import_ag_charts_community161._ModuleSupport.LABEL_BOXING_DEFAULTS,
          enabled: true,
          color: { $ref: "textColor" },
          fontStyle: void 0,
          fontWeight: { $ref: "fontWeight" },
    ...
    gradientLegend: {
      enabled: true,
      ...import_ag_charts_community161._ModuleSupport.LEGEND_CONTAINER_THEME
    }
  }
};
...
// packages/ag-charts-enterprise/src/main-modules.ts
var ModuleRegistry = import_ag_charts_community162._ModuleSupport.ModuleRegistry;
