...
var { Chart: Chart2, MercatorScale, ChartAxisDirection: ChartAxisDirection6, Property: Property11 } = _ModuleSupport16;
...
var { BaseProperties: BaseProperties2, AbstractBarSeriesProperties, makeSeriesTooltip, Property: Property12, mergeDefaults } = _ModuleSupport20;
...
var BoxPlotSeries = class extends _ModuleSupport21.AbstractBarSeries {
  ...
  legendItemSymbol() {
    ...
    return {
      marker: {
        fill: _ModuleSupport21.deepClone(fill),
        fillOpacity,
        stroke,
        strokeOpacity,
        strokeWidth,
...
import { boolean as boolean2, constant as constant2, required as required2, shapeSegmentation, string as string2 } from "ag-charts-core";
...
var BoxPlotModule = {
  ...
  predictAxis: _ModuleSupport24.predictCartesianTimeAxis,
...
var { Path: Path6, SceneChangeDetection: SceneChangeDetection2, BBox: BBox3 } = _ModuleSupport27;
...
// packages/ag-charts-enterprise/src/series/candlestick/candlestickNode.ts
var { SceneArrayChangeDetection: SceneArrayChangeDetection2, SceneChangeDetection: SceneChangeDetection3, ExtendedPath2D: ExtendedPath2D2, BBox: BBox4 } = _ModuleSupport28;
...
// packages/ag-charts-enterprise/src/series/candlestick/candlestickSeriesProperties.ts
var { BaseProperties: BaseProperties4, makeSeriesTooltip: makeSeriesTooltip3, Property: Property14 } = _ModuleSupport30;
...
// packages/ag-charts-enterprise/src/series/candlestick/candlestickSeries.ts
var { isGradientFill, isPatternFill, isImageFill, applyShapeStyle } = _ModuleSupport31;
...
import { Logger as Logger2, cachedTextMeasurer, findMaxValue, wrapLines } from "ag-charts-core";
...
var { Property: Property15 } = _ModuleSupport35;
var BaseAutoSizedLabel = class extends _ModuleSupport35.Label {
  constructor() {
    super(...arguments);
...
// packages/ag-charts-enterprise/src/series/heatmap/heatmapSeriesProperties.ts
var { CartesianSeriesProperties, makeSeriesTooltip: makeSeriesTooltip4, Property: Property16 } = _ModuleSupport36;
...
var HeatmapSeriesNodeEvent = class extends _ModuleSupport37.CartesianSeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
...
var HeatmapSeries = class extends _ModuleSupport37.CartesianSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      propertyKeys: {
  ...
  async processData(dataController) {
    ...
    if (this.isColorScaleValid()) {
      ...
      const domain = _ModuleSupport37.extent(rawDomain);
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs3, heatmapSeriesThemeableOptionsDef, without } = _ModuleSupport38;
  ...
  series: {
    ...
    colorRange: {
      $if: [
        ...
        _ModuleSupport39.SAFE_RANGE2_OPERATION
      ]
    },
    label: {
      ..._ModuleSupport39.LABEL_BOXING_DEFAULTS,
      enabled: false,
      color: { $ref: "textColor" },
    ...
    itemPadding: 3,
    highlight: _ModuleSupport39.singleSeriesHighlightStyle()
  },
  gradientLegend: {
    enabled: true,
    ..._ModuleSupport39.LEGEND_CONTAINER_THEME
  }
};
...
var { applyShapeStyle: applyShapeStyle3 } = _ModuleSupport41;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs4, ohlcSeriesThemeableOptionsDef } = _ModuleSupport42;
...
var RangeAreaSeriesNodeEvent = class extends _ModuleSupport47.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.xKey = series.properties.xKey;
...
var RangeAreaSeries = class extends _ModuleSupport47.CartesianSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      pathsPerSeries: ["fill", "stroke"],
      pickModes: [_ModuleSupport47.SeriesNodePickMode.AXIS_ALIGNED],
      propertyKeys: {
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs5, rangeAreaSeriesThemeableOptionsDef } = _ModuleSupport48;
  ...
  series: {
    fill: {
      $applySwitch: [
        { $path: "type" },
        { $palette: "fill" },
        ["gradient", _ModuleSupport49.FILL_GRADIENT_LINEAR_DEFAULTS],
        ["pattern", _ModuleSupport49.FILL_PATTERN_DEFAULTS]
      ]
    },
    stroke: { $palette: "stroke" },
    fillOpacity: 0.7,
    ...
    marker: {
      ...
      fill: {
        $applySwitch: [
          { $path: "type" },
          { $palette: "fill" },
          ["gradient", _ModuleSupport49.FILL_GRADIENT_RADIAL_REVERSED_DEFAULTS],
          ["image", _ModuleSupport49.FILL_IMAGE_DEFAULTS],
          ["pattern", _ModuleSupport49.FILL_PATTERN_DEFAULTS]
        ]
      },
      stroke: { $palette: "stroke" },
    ...
    label: {
      ..._ModuleSupport49.LABEL_BOXING_DEFAULTS,
      enabled: false,
      placement: "outside",
    ...
    highlight: _ModuleSupport49.multiSeriesHighlightStyle(),
    segmentation: _ModuleSupport49.SEGMENTATION_DEFAULTS
  },
  axes: {
    [_ModuleSupport49.ThemeConstants.CARTESIAN_AXIS_TYPE.NUMBER]: {
...
var RangeAreaModule = {
  ...
  predictAxis: _ModuleSupport50.predictCartesianTimeAxis,
  defaultAxes: [
...
var { aggregationDomain: aggregationDomain3, aggregationRangeFittingPoints: aggregationRangeFittingPoints3, compactAggregationIndices: compactAggregationIndices3, createAggregationIndices: createAggregationIndices3 } = _ModuleSupport51;
...
var { AbstractBarSeriesProperties: AbstractBarSeriesProperties3, makeSeriesTooltip: makeSeriesTooltip6, Property: Property18, DropShadow: DropShadow2, Label: Label2 } = _ModuleSupport52;
...
var RangeBarSeriesNodeEvent = class extends _ModuleSupport53.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.xKey = series.properties.xKey;
    this.yLowKey = series.properties.yLowKey;
...
var RangeBarSeries = class extends _ModuleSupport53.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  animateWaitingUpdateReady(data) {
    ...
    const dataDiff = _ModuleSupport53.calculateDataDiff(
      this.id,
      datumSelections,
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs6, rangeBarSeriesThemeableOptionsDef } = _ModuleSupport54;
  ...
  series: {
    ...
    fill: {
      $applySwitch: [
        { $path: "type" },
        { $palette: "fill" },
        ["gradient", _ModuleSupport55.FILL_GRADIENT_LINEAR_DEFAULTS],
        ["image", _ModuleSupport55.FILL_IMAGE_DEFAULTS],
        ["pattern", _ModuleSupport55.FILL_PATTERN_DEFAULTS]
      ]
    },
    stroke: { $palette: "stroke" },
    strokeWidth: { $isUserOption: ["./stroke", 2, 0] },
    label: {
      ..._ModuleSupport55.LABEL_BOXING_DEFAULTS,
      enabled: false,
      fontSize: { $ref: "fontSize" },
      fontFamily: { $ref: "fontFamily" },
      fontWeight: { $ref: "fontWeight" },
    ...
    highlight: _ModuleSupport55.multiSeriesHighlightStyle(),
    segmentation: _ModuleSupport55.SEGMENTATION_DEFAULTS
  },
  axes: {
...
var RangeBarModule = {
  ...
  predictAxis: _ModuleSupport56.predictCartesianTimeAxis,
  defaultAxes: _ModuleSupport56.DIRECTION_SWAP_AXES,
...
var { AbstractBarSeriesProperties: AbstractBarSeriesProperties4, BaseProperties: BaseProperties5, PropertiesArray, makeSeriesTooltip: makeSeriesTooltip7, Property: Property19, DropShadow: DropShadow3, Label: Label3 } = _ModuleSupport57;
...
var WaterfallSeries = class extends _ModuleSupport58.AbstractBarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  async processData(dataController) {
    ...
    const { processedData } = await this.requestDataModel(dataController, dataWithTotals, {
      props: [
        ...
        ...isContinuousX ? [_ModuleSupport58.SMALLEST_KEY_INTERVAL, _ModuleSupport58.LARGEST_KEY_INTERVAL] : [],
        ...extraProps
      ]
    });
    this.smallestDataInterval = processedData.reduced?.smallestKeyInterval;
  ...
  animateConnectorLinesHorizontal(opts) {
    ...
    this.ctx.animationManager.animate({
      ...
      from: startX,
      to: endX,
      ease: _ModuleSupport58.Motion.easeOut,
      collapsable: false,
      onUpdate(pointX) {
        linePath.clear(true);
  ...
  updateLineNode(lineNode) {
    ...
    lineNode.setProperties({
      ...
      lineDashOffset,
      lineJoin: "round",
      pointerEvents: _ModuleSupport58.PointerEvents.None
    });
  }
  isLabelEnabled() {
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs7, waterfallSeriesThemeableOptionsDef } = _ModuleSupport59;
...
var { FILL_GRADIENT_LINEAR_SHADED_DEFAULTS: FILL_GRADIENT_LINEAR_SHADED_DEFAULTS2, FILL_IMAGE_DEFAULTS: FILL_IMAGE_DEFAULTS3, FILL_PATTERN_DEFAULTS: FILL_PATTERN_DEFAULTS3 } = _ModuleSupport60;
function itemTheme2(key, index) {
  return {
    ...
    strokeWidth: { $isUserOption: ["./stroke", 2, 0] },
    label: {
      ..._ModuleSupport60.LABEL_BOXING_DEFAULTS,
      enabled: false,
      fontStyle: void 0,
      fontWeight: { $ref: "fontWeight" },
      fontSize: { $ref: "fontSize" },
...
var WATERFALL_SERIES_THEME = {
  series: {
    ...
    highlight: _ModuleSupport60.singleSeriesHighlightStyle()
  },
  legend: {
    enabled: true,
    toggleSeries: false
...
// packages/ag-charts-enterprise/src/features/sync/pluginModules.ts
var { annotationOptionsDef } = _ModuleSupport63;
...
import { Logger as Logger5, cachedTextMeasurer as cachedTextMeasurer2, calcLineHeight, wrapText as wrapText2 } from "ag-charts-core";
...
function removeCircularLinks(links) {
  ...
  if (circularLinks.size !== 0) {
    Logger4.warnOnce("Some links formed circular references. These will be removed from the output.");
  }
...
// packages/ag-charts-enterprise/src/series/flow-proportion/flowProportionSeries.ts
var { Series, DataController, keyProperty: keyProperty6, valueProperty: valueProperty7, Selection: Selection3, Group: Group5, TransformableText } = _ModuleSupport64;
var FlowProportionSeriesNodeEvent = class extends _ModuleSupport64.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
...
var { Path: Path7, SceneChangeDetection: SceneChangeDetection4 } = _ModuleSupport65;
...
import {
  _ModuleSupport as _ModuleSupport66
} from "ag-charts-community";
var {
...
var ChordSeries = class extends FlowProportionSeries {
  ...
  createNodeData() {
    ...
    if (this.isLabelEnabled()) {
      const measurer = cachedTextMeasurer2(this.properties.label);
      let maxMeasuredLabelWidth = 0;
      nodeGraph.forEach(({ datum: node }) => {
        const { id, label } = node;
        if (label == null)
          return;
        const text = wrapText2(label, {
    ...
    if (nodeCount * spacingSweep >= 2 * Math.PI || radius <= 0) {
      Logger5.warnOnce("There was insufficient space to display the Chord Series.");
      return;
    }
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs8, chordSeriesThemeableOptionsDef } = _ModuleSupport68;
...
var ChordModule = {
  ...
  themeTemplate: {
    series: {
      ...
      // @ts-expect-error undocumented option
      fillGradientDefaults: _ModuleSupport69.FILL_GRADIENT_LINEAR_DEFAULTS,
      fillPatternDefaults: _ModuleSupport69.FILL_PATTERN_DEFAULTS,
      fillImageDefaults: _ModuleSupport69.FILL_IMAGE_DEFAULTS,
      highlightStyle: {
        series: {
          dimOpacity: 0.2
        }
      },
      highlight: _ModuleSupport69.singleSeriesHighlightStyle(),
      label: {
        ..._ModuleSupport69.LABEL_BOXING_DEFAULTS,
        fontFamily: { $ref: "fontFamily" },
        fontSize: { $ref: "fontSize" },
        fontWeight: { $ref: "fontWeight" },
        color: { $ref: "textColor" },
      ...
      $applyCycle: [
        ...
        [{ $path: ["/0", void 0, { $palette: "fills" }] }],
        {
          $applySwitch: [
            ...
            { $value: "$1" },
            ["gradient", _ModuleSupport70.FILL_GRADIENT_LINEAR_SINGLE_DEFAULTS],
            ["pattern", _ModuleSupport70.FILL_PATTERN_SINGLE_DEFAULTS],
            ["image", _ModuleSupport70.FILL_IMAGE_DEFAULTS]
          ]
        }
      ]
    },
...
import {
  _ModuleSupport as _ModuleSupport75
} from "ag-charts-community";
...
var { lineDistanceSquared, BBox: BBox7, Path: Path8, SceneChangeDetection: SceneChangeDetection5 } = _ModuleSupport71;
var delta = 1e-6;
...
var { NODE_UPDATE_STATE_TO_PHASE_MAPPING } = _ModuleSupport72;
...
var FunnelSeriesNodeEvent = class extends _ModuleSupport73.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
...
var BaseFunnelSeries = class extends _ModuleSupport73.AbstractBarSeries {
  constructor({
    moduleCtx,
    animationResetFns
  }) {
...
var { Label: Label5, AbstractBarSeriesProperties: AbstractBarSeriesProperties5, makeSeriesTooltip: makeSeriesTooltip9, AxisLabel, Property: Property21 } = _ModuleSupport74;
...
// packages/ag-charts-enterprise/src/series/cone-funnel/coneFunnelSeries.ts
var { Line: Line3, ChartAxisDirection: ChartAxisDirection14 } = _ModuleSupport75;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs9, coneFunnelSeriesThemeableOptionsDef, without: without3 } = _ModuleSupport76;
...
var CONE_FUNNEL_SERIES_THEME = {
  series: {
      ...
      $applyCycle: [
        { $size: { $path: ["./data", { $path: "/data" }] } },
        {
          $if: [
            ...
            _ModuleSupport77.SAFE_RANGE2_OPERATION
          ]
        },
        {
          $applySwitch: [
            { $path: ["/type", void 0, { $value: "$1" }] },
            { $value: "$1" },
            ["gradient", _ModuleSupport77.FILL_GRADIENT_LINEAR_SINGLE_DEFAULTS],
            ["pattern", _ModuleSupport77.FILL_PATTERN_SINGLE_DEFAULTS],
            ["image", _ModuleSupport77.FILL_IMAGE_DEFAULTS]
          ]
        }
      ]
    },
    ...
    strokeWidth: { $isUserOption: ["./strokes/0", 2, 0] },
    label: {
      ..._ModuleSupport77.LABEL_BOXING_DEFAULTS,
      enabled: true,
      fontSize: { $ref: "fontSize" },
      fontFamily: { $ref: "fontFamily" },
      fontWeight: { $ref: "fontWeight" },
    ...
    highlight: _ModuleSupport77.singleSeriesHighlightStyle(false)
  },
  seriesArea: {
    padding: {
      top: 20,
...
import {
  _ModuleSupport as _ModuleSupport79
} from "ag-charts-community";
...
var { Label: Label6, DropShadow: DropShadow4, AbstractBarSeriesProperties: AbstractBarSeriesProperties6, BaseProperties: BaseProperties7, makeSeriesTooltip: makeSeriesTooltip10, AxisLabel: AxisLabel2, Property: Property22 } = _ModuleSupport78;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs10, funnelSeriesThemeableOptionsDef, without: without4 } = _ModuleSupport80;
...
import { cachedTextMeasurer as cachedTextMeasurer4 } from "ag-charts-core";
...
function formatWithContext(ctx, formatter, params) {
  return _ModuleSupport81.callWithContext(ctx.chartService, formatter, params);
}
...
var { BaseProperties: BaseProperties8, Property: Property23 } = _ModuleSupport82;
...
var LinearGaugeBarProperties = class extends BaseProperties9 {
  constructor() {
    ...
    this.fills = new PropertiesArray2(_ModuleSupport83.StopProperties);
...
import { cachedTextMeasurer as cachedTextMeasurer3 } from "ag-charts-core";
var { BBox: BBox8 } = _ModuleSupport84;
...
function formatLinearGaugeLabels(series, ctx, selection, opts, bboxes, datumOverrides) {
  ...
  selection.each((label, labelDatum) => {
    ...
    if (labelText == null) {
      ...
      const measurer = cachedTextMeasurer3(labelDatum);
...
var LinearGaugeSeries = class extends _ModuleSupport85.Series {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  updateDatumNodes(opts) {
    ...
    datumSelection.each((rect, datum) => {
      ...
      rect.pointerEvents = this.properties.bar.enabled ? _ModuleSupport85.PointerEvents.All : _ModuleSupport85.PointerEvents.None;
    ...
    this.datumUnion.update(datumSelection, this.itemGroup, _ModuleSupport85.Rect, (node, first, last) => {
      ...
      node.pointerEvents = _ModuleSupport85.PointerEvents.None;
      node.x = left;
      node.y = top;
      node.width = width;
      node.height = height;
    ...
    series: {
      ...
      defaultColorRange: {
        $if: [
          ...
          _ModuleSupport86.SAFE_RANGE2_OPERATION
        ]
      },
      scale: {
        // @ts-expect-error undocumented option
        ...
        stroke: { $path: ["/2", _ModuleSupport86.SAFE_STROKE_FILL_OPERATION, { $palette: "hierarchyColors" }] },
        // TODO: mix backgroundColor and foregroundColor?
        strokeWidth: { $isUserOption: ["./stroke", 2, 0] },
        label: {
          spacing: 11
      ...
      label: {
        ..._ModuleSupport86.LABEL_BOXING_DEFAULTS,
        enabled: false,
        placement: "inside-start",
        fontFamily: { $ref: "fontFamily" },
        fontWeight: { $ref: "fontWeight" },
        fontSize: { $rem: 2 },
        minimumFontSize: _ModuleSupport86.FONT_SIZE.SMALL,
        spacing: 18,
        color: { $ref: "chartBackgroundColor" }
      },
      margin: 4,
...
var LinearGaugeSeriesModule = {
  ...
  chartType: "standalone",
  enterprise: true,
  options: _ModuleSupport86.linearGaugeSeriesOptionsDef,
...
var MAP_THEME_DEFAULTS = {
  ...
  gradientLegend: {
    enabled: false,
    ..._ModuleSupport87.LEGEND_CONTAINER_THEME
  }
};
function applyMapPalette(object) {
  const clone = _ModuleSupport87.deepClone(object);
  _ModuleSupport87.jsonWalk(clone, (value) => {
...
import { Logger as Logger7, cachedTextMeasurer as cachedTextMeasurer5 } from "ag-charts-core";
...
var { LonLatBBox } = _ModuleSupport88;
...
// packages/ag-charts-enterprise/src/series/map-util/geoGeometry.ts
var { Path: Path9, ExtendedPath2D: ExtendedPath2D3, BBox: BBox10, SceneChangeDetection: SceneChangeDetection6, SceneObjectChangeDetection, objectsEqual } = _ModuleSupport89;
...
var { LonLatBBox: LonLatBBox2 } = _ModuleSupport90;
...
var TopologySeriesProperties = class extends _ModuleSupport91.SeriesProperties {
};
var TopologySeries = class extends _ModuleSupport91.DataModelSeries {
...
var { Property: Property25, SeriesProperties: SeriesProperties3, makeSeriesTooltip: makeSeriesTooltip12, Label: Label8 } = _ModuleSupport92;
...
var MapLineSeries = class extends TopologySeries {
  ...
  async processData(dataController) {
    ...
    if (topology == null) {
      Logger7.warnOnce(`no topology was provided for [MapLineSeries]; nothing will be rendered.`);
    }
  }
  isColorScaleValid() {
    const { colorKey } = this.properties;
  ...
  createNodeData() {
    ...
    const measurer = cachedTextMeasurer5(label);
    ...
    if (missingGeometries.length > 0) {
      Logger7.warnOnce(`some data items do not have matches in the provided topology`, missingGeometries);
    }
    return {
      itemId: seriesId,
      nodeData,
  ...
  updatePlacedLabelData(labelData) {
    this.labelSelection = this.labelSelection.update(labelData, (text) => {
      text.pointerEvents = _ModuleSupport93.PointerEvents.None;
    });
    this.updateLabelNodes({ labelSelection: this.labelSelection });
  }
  updateLabelNodes(opts) {
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs11, mapLineSeriesThemeableOptionsDef, without: without5 } = _ModuleSupport94;
...
var MapLineModule = {
  ...
  themeTemplate: {
    ...MAP_THEME_DEFAULTS,
    series: {
      stroke: applyMapPalette(_ModuleSupport95.SAFE_STROKE_FILL_OPERATION),
      // @ts-expect-error undocumented option
      colorRange: {
        $if: [
          { $eq: [{ $mapPalette: "type" }, "inbuilt"] },
          { $mapPalette: "divergingColors" },
          applyMapPalette(_ModuleSupport95.SAFE_RANGE2_OPERATION)
        ]
      },
      strokeWidth: 1,
      maxStrokeWidth: 3,
      ...
      lineDashOffset: 0,
      label: {
        ..._ModuleSupport95.LABEL_BOXING_DEFAULTS,
        enabled: true,
        fontSize: { $ref: "fontSize" },
        fontFamily: { $ref: "fontFamily" },
        fontWeight: { $ref: "fontWeight" },
      ...
      highlight: applyMapPalette(_ModuleSupport95.multiSeriesHighlightStyle(false))
    },
    tooltip: {
      range: "exact"
    }
...
var { Property: Property26, SeriesProperties: SeriesProperties4, makeSeriesTooltip: makeSeriesTooltip13 } = _ModuleSupport96;
...
// packages/ag-charts-enterprise/src/series/map-line-background/mapLineBackgroundSeries.ts
var { createDatumId: createDatumId11, Group: Group8, Selection: Selection7, PointerEvents: PointerEvents6 } = _ModuleSupport97;
var MapLineBackgroundSeries = class extends TopologySeries {
  ...
  processData() {
    ...
    if (topology == null) {
      Logger8.warnOnce(`no topology was provided for [MapShapeBackgroundSeries]; nothing will be rendered.`);
    }
  }
  createNodeData() {
...
var { mapLineBackgroundSeriesThemeableOptionsDef } = _ModuleSupport98;
...
import { Logger as Logger9, cachedTextMeasurer as cachedTextMeasurer6 } from "ag-charts-core";
...
var { BBox: BBox11 } = _ModuleSupport99;
...
var { Property: Property27, SeriesProperties: SeriesProperties5, makeSeriesTooltip: makeSeriesTooltip14, Label: Label9 } = _ModuleSupport100;
...
var MapMarkerSeries = class extends TopologySeries {
  ...
  createNodeData() {
    ...
    if (missingGeometries.length > 0) {
      Logger9.warnOnce(`some data items do not have matches in the provided topology`, missingGeometries);
    }
    return {
      itemId: seriesId,
      nodeData,
  ...
  updatePlacedLabelData(labelData) {
    this.labelSelection = this.labelSelection.update(labelData, (text) => {
      text.pointerEvents = _ModuleSupport101.PointerEvents.None;
    });
    this.updateLabelNodes({ labelSelection: this.labelSelection });
  }
  updateLabelNodes(opts) {
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs12, mapMarkerSeriesThemeableOptionsDef, without: without6 } = _ModuleSupport102;
    ...
    series: {
      ...
      fill: applyMapPalette({
        $applySwitch: [
          { $path: "type" },
          { $mapPalette: "fill" },
          ["gradient", _ModuleSupport103.FILL_GRADIENT_RADIAL_REVERSED_DEFAULTS],
          ["image", _ModuleSupport103.FILL_IMAGE_DEFAULTS],
          ["pattern", _ModuleSupport103.FILL_PATTERN_DEFAULTS]
        ]
      }),
      ...
      colorRange: {
        $if: [
          { $eq: [{ $mapPalette: "type" }, "inbuilt"] },
          { $mapPalette: "divergingColors" },
          applyMapPalette(_ModuleSupport103.SAFE_RANGE2_OPERATION)
        ]
      },
      fillOpacity: 0.5,
      label: {
        ..._ModuleSupport103.LABEL_BOXING_DEFAULTS,
        enabled: false,
        fontSize: { $ref: "fontSize" },
        fontFamily: { $ref: "fontFamily" },
        fontWeight: { $ref: "fontWeight" },
      ...
      highlight: applyMapPalette(_ModuleSupport103.multiSeriesHighlightStyle())
    },
    tooltip: {
      range: "exact"
    }
...
import { Logger as Logger10, cachedTextMeasurer as cachedTextMeasurer7, calcLineHeight as calcLineHeight2 } from "ag-charts-core";
...
var { Property: Property28, SeriesProperties: SeriesProperties6, makeSeriesTooltip: makeSeriesTooltip15 } = _ModuleSupport104;
...
var fixedScale = _ModuleSupport105.MercatorScale.fixedScale();
var MapShapeSeries = class extends TopologySeries {
  ...
  async processData(dataController) {
    ...
    if (topology == null) {
      Logger10.warnOnce(`no topology was provided for [MapShapeSeries]; nothing will be rendered.`);
    }
  }
  isColorScaleValid() {
    const { colorKey } = this.properties;
  ...
  getLabelLayout(datum, labelValue, measurer, geometry, previousLabelLayout) {
    ...
    const aspectRatio = (baseSize.width + 2 * padding) / (numLines * calcLineHeight2(label.fontSize) + 2 * padding);
  ...
  createNodeData() {
    ...
    const labelValues = labelKey != null ? dataModel.resolveColumnById(this, `labelValue`, processedData) : void 0;
    const colorValues = colorKey != null ? dataModel.resolveColumnById(this, `colorValue`, processedData) : void 0;
    const measurer = cachedTextMeasurer7(label);
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs13, mapShapeSeriesThemeableOptionsDef, without: without7 } = _ModuleSupport106;
    ...
    series: {
      fill: applyMapPalette({
        $applySwitch: [
          { $path: "type" },
          { $mapPalette: "fill" },
          ["gradient", _ModuleSupport107.FILL_GRADIENT_LINEAR_DEFAULTS],
          ["image", _ModuleSupport107.FILL_IMAGE_DEFAULTS],
          ["pattern", _ModuleSupport107.FILL_PATTERN_DEFAULTS]
        ]
      }),
      ...
      colorRange: {
        $if: [
          { $eq: [{ $mapPalette: "type" }, "inbuilt"] },
          { $mapPalette: "divergingColors" },
          applyMapPalette(_ModuleSupport107.SAFE_RANGE2_OPERATION)
        ]
      },
      fillOpacity: 1,
      strokeWidth: 1,
      ...
      padding: 2,
      label: {
        ..._ModuleSupport107.LABEL_BOXING_DEFAULTS,
        color: { $ref: "chartBackgroundColor" },
        fontFamily: { $ref: "fontFamily" },
        fontSize: { $ref: "fontSize" },
        fontWeight: "bold",
      ...
      highlight: applyMapPalette(_ModuleSupport107.multiSeriesHighlightStyle(true))
    },
    tooltip: {
      range: "exact"
    }
...
var { Property: Property29, SeriesProperties: SeriesProperties7, makeSeriesTooltip: makeSeriesTooltip16 } = _ModuleSupport108;
...
// packages/ag-charts-enterprise/src/series/map-shape-background/mapShapeBackgroundSeries.ts
var { createDatumId: createDatumId14, Selection: Selection10, Group: Group11, PointerEvents: PointerEvents8 } = _ModuleSupport109;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs14, mapShapeBackgroundSeriesThemeableOptionsDef } = _ModuleSupport110;
    ...
    series: {
      fill: applyMapPalette({
        $applySwitch: [
          ...
          ["gradient", _ModuleSupport111.FILL_GRADIENT_LINEAR_HIERARCHY_DEFAULTS],
          ["image", _ModuleSupport111.FILL_IMAGE_DEFAULTS],
          ["pattern", _ModuleSupport111.FILL_PATTERN_HIERARCHY_DEFAULTS]
        ]
      }),
      stroke: { $ref: "chartBackgroundColor" },
      strokeWidth: 1
...
var RadialColumnSeriesNodeEvent = class extends _ModuleSupport112.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
...
var RadialColumnSeriesBase = class extends _ModuleSupport112.PolarSeries {
  constructor(moduleCtx, {
    animationResetFns
  }) {
    super({
  ...
  legendItemSymbol() {
    ...
    if (_ModuleSupport112.isGradientFill(markerStyle.fill)) {
...
var { SeriesProperties: SeriesProperties8, makeSeriesTooltip: makeSeriesTooltip17, Property: Property30, Label: Label10 } = _ModuleSupport113;
...
var { motion: motion7 } = _ModuleSupport114;
...
// packages/ag-charts-enterprise/src/series/nightingale/nightingaleUtil.ts
var { SectorBox, motion: motion8 } = _ModuleSupport115;
...
// packages/ag-charts-enterprise/src/series/nightingale/nightingaleSeries.ts
var { Sector: Sector4, SectorBox: SectorBox2, PolarZIndexMap } = _ModuleSupport116;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs15, nightingaleSeriesThemeableOptionsDef } = _ModuleSupport117;
...
import {
  _ModuleSupport as _ModuleSupport121
} from "ag-charts-community";
import { cachedTextMeasurer as cachedTextMeasurer8, calcLineHeight as calcLineHeight3 } from "ag-charts-core";
...
var { SeriesProperties: SeriesProperties9, makeSeriesTooltip: makeSeriesTooltip18, Property: Property31, Label: Label11, DropShadow: DropShadow5 } = _ModuleSupport120;
...
var PyramidSeries = class extends _ModuleSupport121.DataModelSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      categoryKey: void 0,
  ...
  createNodeData() {
    ...
    const textMeasurer = cachedTextMeasurer8(stageLabel);
    let textAlign;
    let textBaseline;
    if (horizontal) {
      textAlign = "center";
    ...
    rawData.forEach((datum, datumIndex) => {
      ...
      const height = text.split("\n").length * calcLineHeight3(label.fontSize);
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs16, pyramidSeriesThemeableOptionsDef } = _ModuleSupport122;
      ...
      $applyCycle: [
        ...
        { $palette: "fills" },
        {
          $applySwitch: [
            { $path: ["/type", void 0, { $value: "$1" }] },
            { $value: "$1" },
            ["gradient", _ModuleSupport123.FILL_GRADIENT_LINEAR_DEFAULTS],
            ["pattern", _ModuleSupport123.FILL_PATTERN_DEFAULTS],
            ["image", _ModuleSupport123.FILL_IMAGE_DEFAULTS]
          ]
        }
      ]
    },
...
var BASE_RADAR_SERIES_THEME = {
  series: {
    ...
    marker: {
      ...
      fill: {
        $applySwitch: [
          { $path: "type" },
          { $palette: "fill" },
          ["gradient", _ModuleSupport124.FILL_GRADIENT_RADIAL_REVERSED_DEFAULTS],
          ["image", _ModuleSupport124.FILL_IMAGE_DEFAULTS],
          ["pattern", _ModuleSupport124.FILL_PATTERN_DEFAULTS]
        ]
      },
      stroke: { $palette: "stroke" },
      fillOpacity: 1,
    ...
    highlight: _ModuleSupport124.multiSeriesHighlightStyle(),
    tooltip: {
      range: { $path: ["/tooltip/range", "nearest"] }
    }
  },
...
var RADAR_LINE_SERIES_THEME = _ModuleSupport124.mergeDefaults(
  {
    series: {
      stroke: _ModuleSupport124.SAFE_STROKE_FILL_OPERATION,
      strokeWidth: 2
    }
  },
  BASE_RADAR_SERIES_THEME
);
var RADAR_AREA_SERIES_THEME = _ModuleSupport124.mergeDefaults(
  {
    series: {
      fill: {
        $applySwitch: [
          { $path: "type" },
          { $palette: "fill" },
          ["gradient", _ModuleSupport124.FILL_GRADIENT_LINEAR_DEFAULTS],
          ["image", _ModuleSupport124.FILL_IMAGE_DEFAULTS],
          ["pattern", _ModuleSupport124.FILL_PATTERN_DEFAULTS]
        ]
      },
...
import {
  _ModuleSupport as _ModuleSupport126
} from "ag-charts-community";
...
var { Label: Label12, SeriesMarker: SeriesMarker2, SeriesProperties: SeriesProperties10, makeSeriesTooltip: makeSeriesTooltip19, Property: Property32 } = _ModuleSupport125;
...
var RadarSeriesNodeEvent = class extends _ModuleSupport126.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.angleKey = series.properties.angleKey;
    this.radiusKey = series.properties.radiusKey;
...
var RadarSeries = class extends _ModuleSupport126.PolarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
      categoryKey: "angleValue",
...
var { Property: Property33 } = _ModuleSupport127;
...
// packages/ag-charts-enterprise/src/series/radar-area/radarAreaSeries.ts
var { Group: Group14, Path: Path11, PointerEvents: PointerEvents11, Selection: Selection13, ChartAxisDirection: ChartAxisDirection18, applyShapeStyle: applyShapeStyle15, mergeDefaults: mergeDefaults17 } = _ModuleSupport128;
var RadarAreaSeries = class extends RadarSeries {
  ...
  getAreaPoints() {
    ...
    const getPolarAxis = (direction) => {
      ...
      return axis instanceof _ModuleSupport128.PolarAxis ? axis : void 0;
    };
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs17, radarAreaSeriesThemeableOptionsDef } = _ModuleSupport129;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs18, radarLineSeriesThemeableOptionsDef } = _ModuleSupport131;
...
// packages/ag-charts-enterprise/src/series/radar-line/radarLineModule.ts
var { POLAR_AXIS_TYPE: POLAR_AXIS_TYPE5 } = _ModuleSupport132.ThemeConstants;
var RadarLineModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
var { SeriesProperties: SeriesProperties11, makeSeriesTooltip: makeSeriesTooltip20, Property: Property34, Label: Label13 } = _ModuleSupport133;
...
var { SectorBox: SectorBox3, motion: motion9 } = _ModuleSupport134;
...
var RadialBarSeriesNodeEvent = class extends _ModuleSupport135.SeriesNodeEvent {
  constructor(type, nativeEvent, datum, series) {
    super(type, nativeEvent, datum, series);
    this.angleKey = series.properties.angleKey;
    this.radiusKey = series.properties.radiusKey;
...
var RadialBarSeries = class extends _ModuleSupport135.PolarSeries {
  constructor(moduleCtx) {
    super({
      moduleCtx,
  ...
  updateSectorSelection(selection, isHighlight) {
    ...
    selection.update(selectionData, void 0, (datum) => this.getDatumId(datum)).each((node, nodeDatum) => {
      ...
      const fill = style.fill;
      const fillParams = _ModuleSupport135.isGradientFill(fill) && fill.bounds !== "item" ? { centerX: 0, centerY: 0 } : void 0;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs19, radialBarSeriesThemeableOptionsDef } = _ModuleSupport136;
...
var RADIAL_BAR_SERIES_THEME = {
  series: {
    ...
    strokeWidth: { $isUserOption: ["./stroke", 1, 0] },
    label: {
      ..._ModuleSupport137.LABEL_BOXING_DEFAULTS,
      enabled: false,
      fontSize: { $ref: "fontSize" },
      fontFamily: { $ref: "fontFamily" },
      fontWeight: { $ref: "fontWeight" },
    ...
    highlight: _ModuleSupport137.multiSeriesHighlightStyle()
  },
  axes: {
...
// packages/ag-charts-enterprise/src/series/radial-bar/radialBarModule.ts
var { POLAR_AXIS_TYPE: POLAR_AXIS_TYPE7 } = _ModuleSupport138.ThemeConstants;
var RadialBarModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
...
var { Property: Property35 } = _ModuleSupport139;
...
// packages/ag-charts-enterprise/src/series/radial-column/radialColumnSeries.ts
var { ChartAxisDirection: ChartAxisDirection20, PolarAxis: PolarAxis4, RadialColumnShape, getRadialColumnWidth } = _ModuleSupport140;
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs20, radialColumnSeriesThemeableOptionsDef } = _ModuleSupport141;
...
var RADIAL_COLUMN_SERIES_THEME = {
  series: {
    ...
    strokeWidth: { $isUserOption: ["./stroke", 1, 0] },
    label: {
      ..._ModuleSupport142.LABEL_BOXING_DEFAULTS,
      enabled: false,
      fontSize: { $ref: "fontSize" },
      fontFamily: { $ref: "fontFamily" },
      fontWeight: { $ref: "fontWeight" },
    ...
    highlight: _ModuleSupport142.multiSeriesHighlightStyle()
  },
  axes: {
...
// packages/ag-charts-enterprise/src/series/radial-column/radialColumnModule.ts
var { POLAR_AXIS_TYPE: POLAR_AXIS_TYPE9 } = _ModuleSupport143.ThemeConstants;
...
import { cachedTextMeasurer as cachedTextMeasurer9 } from "ag-charts-core";
...
var { SvgPath, Rotatable, Translatable, Scalable: Scalable2 } = _ModuleSupport144;
...
var { getColorStops: getColorStops2, normalizeAngle360: normalizeAngle3606, normalizeAngle360Inclusive: normalizeAngle360Inclusive2, toDegrees } = _ModuleSupport145;
var { BaseProperties: BaseProperties10, makeSeriesTooltip: makeSeriesTooltip21, SeriesProperties: SeriesProperties12, PropertiesArray: PropertiesArray3, AxisLabel: AxisLabel4, Property: Property36, Label: Label14 } = _ModuleSupport145;
...
var RadialGaugeBarProperties = class extends BaseProperties10 {
  constructor() {
    super(...arguments);
    this.enabled = true;
    this.fills = new PropertiesArray3(_ModuleSupport145.StopProperties);
    this.fillMode = "continuous";
    this.fillOpacity = 1;
    this.stroke = "black";
    this.strokeWidth = 0;
...
var { SectorBox: SectorBox5 } = _ModuleSupport146;
...
var RadialGaugeSeries = class extends _ModuleSupport147.Series {
  constructor(moduleCtx) {
    super({
      moduleCtx,
    ...
    this.tickSelection = Selection14.select(this.tickGroup, _ModuleSupport147.TransformableText);
    this.datumUnion = new DatumUnion();
  ...
  layoutScale() {
    ...
    const measurer = cachedTextMeasurer9(label);
  ...
  updateDatumNodes(opts) {
    ...
    datumSelection.each((sector, datum) => {
      ...
      sector.pointerEvents = this.properties.bar.enabled ? _ModuleSupport147.PointerEvents.All : _ModuleSupport147.PointerEvents.None;
    ...
    this.datumUnion.update(datumSelection, this.itemGroup, _ModuleSupport147.Sector, (node, first, last) => {
      ...
      node.pointerEvents = _ModuleSupport147.PointerEvents.None;
    });
  }
  updateScaleSelection(opts) {
    return opts.scaleSelection.update(opts.scaleData, void 0, (datum) => {
...
// packages/ag-charts-enterprise/src/series/radial-gauge/radialGaugeModule.ts
var { FONT_SIZE_RATIO } = _ModuleSupport148;
    ...
    series: {
      ...
      defaultColorRange: {
        $if: [
          { $eq: [{ $palette: "type" }, "inbuilt"] },
          { $interpolate: [{ $palette: "secondDivergingColors" }, 5] },
          _ModuleSupport148.SAFE_RANGE2_OPERATION
        ]
      },
      scale: {
        // @ts-expect-error undocumented option
        defaultFill: { $path: ["/1", { $palette: "fill" }, { $palette: "hierarchyColors" }] },
        // TODO: mix backgroundColor and foregroundColor?
        stroke: { $path: ["/2", _ModuleSupport148.SAFE_STROKE_FILL_OPERATION, { $palette: "hierarchyColors" }] },
        // TODO: mix backgroundColor and foregroundColor?
        strokeWidth: { $isUserOption: ["./stroke", 2, 0] },
        label: {
          fontWeight: { $ref: "fontWeight" },
      ...
      label: {
        ..._ModuleSupport148.LABEL_BOXING_DEFAULTS,
        enabled: true,
        fontWeight: { $ref: "fontWeight" },
        fontSize: 56,
...
var RadialGaugeSeriesModule = {
  ...
  chartType: "standalone",
  enterprise: true,
  options: _ModuleSupport148.radialGaugeSeriesOptionsDef,
...
import { Logger as Logger12, cachedTextMeasurer as cachedTextMeasurer10, calcLineHeight as calcLineHeight4, wrapText as wrapText3 } from "ag-charts-core";
...
var { BBox: BBox15, Path: Path12, SceneChangeDetection: SceneChangeDetection7, splitBezier2D } = _ModuleSupport149;
...
var SankeySeries = class extends FlowProportionSeries {
  ...
  createNodeData() {
    ...
    const measurer = cachedTextMeasurer10(this.properties.label);
    columns.forEach((column, index) => {
      ...
      column.nodes.forEach(({ datum: node }) => {
        ...
        let text;
        if (!leading && !trailing) {
          const lineHeight = calcLineHeight4(fontSize);
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs21, sankeySeriesThemeableOptionsDef } = _ModuleSupport152;
...
var SankeyModule = {
  ...
  themeTemplate: {
    ...
    series: {
      ...
      strokes: { $palette: "strokes" },
      // @ts-expect-error undocumented option
      fillGradientDefaults: _ModuleSupport153.FILL_GRADIENT_LINEAR_DEFAULTS,
      fillPatternDefaults: _ModuleSupport153.FILL_PATTERN_DEFAULTS,
      fillImageDefaults: _ModuleSupport153.FILL_IMAGE_DEFAULTS,
      defaultColorRange: { $palette: "gradients" },
      defaultPatternFills: _ModuleSupport153.SAFE_FILLS_OPERATION,
      highlightStyle: {
        series: {
          dimOpacity: 0.2
        }
      ...
      highlight: {
        ..._ModuleSupport153.singleSeriesHighlightStyle()
      },
      label: {
        ..._ModuleSupport153.LABEL_BOXING_DEFAULTS,
        fontFamily: { $ref: "fontFamily" },
        fontSize: { $ref: "fontSize" },
        fontWeight: { $ref: "fontWeight" },
        color: { $ref: "textColor" },
...
var { HierarchySeriesProperties, HighlightStyle, makeSeriesTooltip: makeSeriesTooltip23, Property: Property38 } = _ModuleSupport154;
...
var SunburstNode = class extends _ModuleSupport155.HierarchyNode {
  constructor() {
    super(...arguments);
    this.label = void 0;
...
var SunburstSeries = class extends _ModuleSupport155.HierarchySeries {
  constructor(moduleCtx) {
    super(moduleCtx);
  ...
  updateNodes() {
    ...
    const updateSector = (nodeDatum, sector, highlighted) => {
      ...
      const fillBBox = _ModuleSupport155.isGradientFill(fill) && fill.bounds !== "item" ? seriesFillBBox : void 0;
  ...
  getTooltipContent(datumIndex) {
    ...
    if (_ModuleSupport155.isGradientFill(markerStyle.fill)) {
      markerStyle.fill = { ...markerStyle.fill, gradient: "linear", rotation: 0, reverse: false };
    }
    return this.formatTooltipWithContext(
      tooltip,
...
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs22, sunburstSeriesThemeableOptionsDef, without: without8 } = _ModuleSupport156;
...
// packages/ag-charts-enterprise/src/series/sunburst/sunburstModule.ts
var { BASE_FONT_SIZE, FONT_SIZE_RATIO: FONT_SIZE_RATIO2 } = _ModuleSupport157;
var SunburstModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
  ...
  themeTemplate: {
    series: {
        ...
        $applyCycle: [
          ...
          { $palette: "fills" },
          {
            $applySwitch: [
              { $path: ["/type", void 0, { $value: "$1" }] },
              { $value: "$1" },
              ["gradient", _ModuleSupport157.FILL_GRADIENT_RADIAL_REVERSED_SERIES_DEFAULTS],
              ["pattern", _ModuleSupport157.FILL_PATTERN_DEFAULTS],
              ["image", _ModuleSupport157.FILL_IMAGE_DEFAULTS]
            ]
          }
        ]
      },
      ...
      strokeWidth: { $isUserOption: ["./strokes/0", 2, 0] },
      label: {
        ..._ModuleSupport157.LABEL_BOXING_DEFAULTS,
        fontFamily: { $ref: "fontFamily" },
    ...
    gradientLegend: {
      enabled: true,
      ..._ModuleSupport157.LEGEND_CONTAINER_THEME
    }
  }
};
...
import {
  _ModuleSupport as _ModuleSupport159
} from "ag-charts-community";
import {
...
var { BaseProperties: BaseProperties12, HierarchySeriesProperties: HierarchySeriesProperties2, HighlightStyle: HighlightStyle2, makeSeriesTooltip: makeSeriesTooltip24, Property: Property39, Label: Label16 } = _ModuleSupport158;
...
var TreemapNode = class extends _ModuleSupport159.HierarchyNode {
  constructor() {
    super(...arguments);
...
var DistantGroup = class extends _ModuleSupport159.Group {
  distanceSquared(x, y) {
    return this.getBBox().distanceSquared(x, y);
  }
};
var TreemapSeries = class extends _ModuleSupport159.HierarchySeries {
  constructor() {
    super(...arguments);
  ...
  groupTitleHeight(node, bbox) {
    ...
    if (labelValue == null) {
      ...
      const { height: fontHeight } = cachedTextMeasurer11(font).measureLines(labelValue);
  ...
  updateNodes() {
    ...
    this.rootNode?.walk((node) => {
      ...
      if (children.length === 0) {
        ...
        const text = wrapText4(labelValue, {
        ...
        node.label = {
          ...
          lineHeight: calcLineHeight5(group.label.fontSize),
          fontStyle,
          fontFamily,
          fontWeight,
          color: color6,
  ...
  getTooltipContent(datumIndex) {
    ...
    if (_ModuleSupport159.isGradientFill(markerStyle.fill)) {
      markerStyle.fill = { ...markerStyle.fill, gradient: "linear", rotation: 0, reverse: false };
    }
...
import { arrayOf as arrayOf5, color as color5, constant as constant25, required as required25, string as string23, undocumented as undocumented8 } from "ag-charts-core";
var { commonSeriesOptionsDefs: commonSeriesOptionsDefs23, treemapSeriesThemeableOptionsDef, without: without9 } = _ModuleSupport160;
...
// packages/ag-charts-enterprise/src/series/treemap/treemapModule.ts
var { FONT_SIZE_RATIO: FONT_SIZE_RATIO3 } = _ModuleSupport161;
var TreemapModule = {
  type: "series",
  optionsKey: "series[]",
  packageType: "enterprise",
  ...
  themeTemplate: {
    series: {
        ...
        $applyCycle: [
          ...
          { $palette: "fills" },
          {
            $applySwitch: [
              { $path: ["/type", void 0, { $value: "$1" }] },
              { $value: "$1" },
              ["gradient", _ModuleSupport161.FILL_GRADIENT_LINEAR_DEFAULTS],
              ["pattern", _ModuleSupport161.FILL_PATTERN_DEFAULTS],
              ["image", _ModuleSupport161.FILL_IMAGE_DEFAULTS]
            ]
          }
        ]
      },
      ...
      group: {
        label: {
          ..._ModuleSupport161.LABEL_BOXING_DEFAULTS,
          enabled: true,
          color: { $ref: "textColor" },
          fontStyle: void 0,
          fontWeight: { $ref: "fontWeight" },
    ...
    gradientLegend: {
      enabled: true,
      ..._ModuleSupport161.LEGEND_CONTAINER_THEME
    }
  }
};
...
// packages/ag-charts-enterprise/src/main-modules.ts
var ModuleRegistry = _ModuleSupport162.ModuleRegistry;
