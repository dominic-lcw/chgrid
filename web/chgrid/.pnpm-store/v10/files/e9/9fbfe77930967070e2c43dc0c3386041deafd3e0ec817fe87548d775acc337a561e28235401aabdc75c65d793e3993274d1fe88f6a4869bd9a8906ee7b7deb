...
export declare class BoxPlotSeriesProperties extends AbstractBarSeriesProperties<AgBoxPlotSeriesOptions> {
    ...
    readonly tooltip: _ModuleSupport.SeriesTooltip<Omit<AgBoxPlotSeriesTooltipRendererParams<any, unknown>, "context">>;
    toJson(): AgBoxPlotSeriesOptions<any, unknown>;
    getStyle(): Required<AgBoxPlotSeriesStyle> & {
        opacity: number;
    };
}
export {};
