...
import type { AgColumn, BeanCollection, CellRange, ChartType, IAggFunc, PartialCellRange, SeriesChartType, SeriesGroupType, SortModelItem } from 'ag-grid-community';
...
export declare class ChartDataModel extends BeanStub {
    ...
    getConvertTime(colId: string): ((date: string | undefined) => Date | undefined) | undefined;
